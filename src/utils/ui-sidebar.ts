...
export const uiSidebarConfig: UISidebarConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Color Picker", slug: "color-picker", updated: true, wip: true },
      ...
      { title: "File Upload", slug: "file-upload", updated: true, wip: true },
      { title: "Input", slug: "input", primitive: true },
      { title: "Kbd", slug: "kbd", updated: true, wip: true },
      ...
      { title: "Onboarding", slug: "onboarding", updated: true, wip: true },
      ...
      { title: "Rating", slug: "rating", updated: true, wip: true },
      ...
      { title: "Text Editor", slug: "text-editor", updated: true, wip: true },
