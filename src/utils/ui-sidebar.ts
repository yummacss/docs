...
export const uiSidebarConfig: UISidebarConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Autocomplete", slug: "autocomplete", updated: true },
      { title: "Avatar", slug: "avatar", updated: true },
      { title: "Button", slug: "button" },
      { title: "Checkbox", slug: "checkbox" },
      { title: "Collapsible", slug: "collapsible", updated: true },
      { title: "Combobox", slug: "combobox" },
      { title: "Context Menu", slug: "context-menu", updated: true },
      { title: "Dialog", slug: "dialog", updated: true },
      { title: "Drawer", slug: "drawer", updated: true },
      { title: "Input", slug: "input" },
      { title: "Menu", slug: "menu", updated: true },
      { title: "Menubar", slug: "menubar", updated: true },
      { title: "Meter", slug: "meter" },
      { title: "Navigation Menu", slug: "navigation-menu", updated: true },
      { title: "Number Field", slug: "number-field" },
      { title: "Popover", slug: "popover", updated: true },
      { title: "Preview Card", slug: "preview-card" },
      { title: "Progress", slug: "progress" },
      { title: "Radio", slug: "radio" },
      { title: "Select", slug: "select", updated: true },
      { title: "Separator", slug: "separator" },
      { title: "Slider", slug: "slider" },
      { title: "Switch", slug: "switch", updated: true },
      { title: "Tabs", slug: "tabs" },
      { title: "Toggle", slug: "toggle", updated: true },
      { title: "Toolbar", slug: "toolbar" },
      { title: "Tooltip", slug: "tooltip", updated: true },
    ],
  },
];
