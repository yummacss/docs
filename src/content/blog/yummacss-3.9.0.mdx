...
<Preview>
  <p className="c-black s::bg-indigo-4 s::c-white">
...
<Preview>
  <input
    className="p-3 w-full bc-red-4 bw-1 br-0 p::c-red-4 p::fs-i"
...
<Preview>
  <div className="d-f jc-c c-white fs-sm">
    <div className="d-14 d-f ai-c jc-c ml--2 bg-indigo bc-indigo-2/50 br-pill bw-2">
      A
    </div>
    <div className="d-14 d-f ai-c jc-c ml--2 bg-indigo bc-indigo-2/50 br-pill bw-2">
      B
...
<div class="d-f jc-c c-white fs-sm">
  <div class="d-14 d-f ai-c jc-c ml--2 bg-indigo bc-indigo-2/50 br-pill bw-2">
    A
  </div>
  <div class="d-14 d-f ai-c jc-c ml--2 bg-indigo bc-indigo-2/50 br-pill bw-2">
    B
