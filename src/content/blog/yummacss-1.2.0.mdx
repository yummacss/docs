...
**This update might change existing features, make sure you check out the check out the [release notes](https://github.com/yumma-css/yumma-css/releases/tag/v1.2.0).**
...
You can check the [release notes](https://github.com/yumma-css/yumma-css/releases/tag/v1.2.0) for the full list of new utilities.
