export const meta = {
  ...
  cover: "~",
  date: "2024-03-21",
  description: "We've been planning to revamp the color palette of Yumma CSS for a while, happy to announce the new version Yumma CSS v1.2.0!",
  title: "Yumma CSS 1.2"
};
...
| `dim-fc`     | `height: fit-content; width: fit-content;`         |
| `max-dim-fc` | `max-height: fit-content; max-width: fit-content;` |
| `min-dim-fc` | `min-height: fit-content; min-width: fit-content;` |
