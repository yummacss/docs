...
<Tabs defaultValue="v1.2">
    <TabsList className="b-1" style={{borderColor: '#31365e'}}>
        <TabsTab className="tc-white b-1 rad-2" style={{backgroundColor: '#21243f', borderColor: '#31365e' }} value="v1.2">v1.2</TabsTab>
        <TabsTab className="tc-white b-1 rad-2" style={{backgroundColor: '#21243f', borderColor: '#31365e' }} value="v1.1">v1.1</TabsTab>
    </TabsList>
