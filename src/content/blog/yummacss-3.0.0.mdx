...
date: 2025-04-14
description: "A complete internal rewrite, a new CLI, significant performance improvements, & over 50 new utilities."
title: Yumma CSS 3.0
---
...
Check the [release notes](https://github.com/yummacss/yummacss/releases/tag/v3.0.0) for a full list of new utilities.
...
```html del={1} ins={2}
<div class="max-dim-(value) …"></div>
<div class="max-d-(value) …"></div>
```

### Min Dimension

```html del={1} ins={2}
<div class="min-dim-(value) …"></div>
<div class="min-d-(value) …"></div>
```
...
```html del={1} ins={2}
<div class="ovf-x-(value) …"></div>
<div class="o-x-(value) …"></div>
```

### Overflow Y

```html del={1} ins={2}
<div class="ovf-y-(value) …"></div>
<div class="o-y-(value)…"></div>
```
