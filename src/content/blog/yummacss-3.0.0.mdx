...
**This update might break your codebase, we highly suggest you checking out the [release notes](https://github.com/yummacss/yummacss/releases/tag/v3.0.0) before upgrading.**
...
You can check the [release notes](https://github.com/yummacss/yummacss/releases/tag/v3.0.0) for the full list of new utilities.
...
<Preview>
  <div className="d-if fd-r cg-8 tc-white" id="area">
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
  </div>
</Preview>
...
<div class="d-if fd-r cg-8 tc-white" id="area">
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
</div>
```
...
<Preview>
  <div className="d-if fd-c rg-8" id="area">
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
    <div className="ai-c bg-indigo d-f d-16 jc-c"></div>
  </div>
...
```html "rg-8"
<div class="d-if fd-c rg-8" id="area">
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
  <div class="ai-c bg-indigo d-f d-16 jc-c"></div>
</div>
