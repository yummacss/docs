export const meta = {
  ...
  title: "Yumma CSS v3.0"
};

**This update might break your codebase, we highly suggest you checking out the [release notes](https://github.com/yumma-lib/yumma-css/releases/tag/v3.0.0) before upgrading.**
...
You can check the [release notes](https://github.com/yumma-lib/yumma-css/releases/tag/v3.0.0) for the full list of new utilities.
