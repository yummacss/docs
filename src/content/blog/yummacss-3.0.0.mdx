  ...
  <Step title="Write CSS">
    ...
    <body>
      <div class="b-1 bc-silver-2 bg-white rad-2 bs-sm p-4">
          ...
          <p class="tc-gray-7">I'm Founder/CEO at Yumma CSS!</p>
...
<Preview>
  <div className="d-if fd-r cg-8 tc-white" id="area">
    <div className="ai-c bg-indigo d-f d-16 jc-c rad-1">A</div>
    <div className="ai-c bg-indigo d-f d-16 jc-c rad-1">B</div>
    <div className="ai-c bg-indigo d-f d-16 jc-c rad-1">C</div>
  </div>
</Preview>
