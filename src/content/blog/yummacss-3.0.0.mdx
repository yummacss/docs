...
We're making some changes to the base styles in v3 to make it more modern and consistent. These changes are turned on by default, but you can turn them off using the [`yumma.config.js`](#disabling-stylecent) file.
