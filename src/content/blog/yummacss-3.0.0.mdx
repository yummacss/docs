export const meta = {
  authors: ["Renildo"],
  cover: "yummacss-3.0.0.png",
  date: "2025-04-14",
  description: "After almost six months of hard work it's finally here - Yumma CSS v3 🎉",
  title: "Yumma CSS 3.0"
};
...
<Tabs defaultValue="v3">
  <TabsList className="b-1" style={{borderColor: '#31365e'}}>
    <TabsTab className="tc-white b-1 rad-2" style={{backgroundColor: '#21243f', borderColor: '#31365e' }} value="v3">v3</TabsTab>
...
We're making some changes to the base styles in v3 to make it more modern and consistent. These changes are turned on by default, but you can turn them off using the config file.
