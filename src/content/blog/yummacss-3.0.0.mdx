export const meta = {
  ...
  cover: "~",
  date: "2025-04-14",
  description: "Yumma CSS v3.0 is here! This major release features a complete internal rewrite, a new CLI, significant performance improvements, & over 50 new utilities.",
  title: "Yumma CSS 3.0"
};
...
<Stepper>
  ...
  <Step title="Compile the SCSS">
    Run `npx yummacss build` to compile your styles.
