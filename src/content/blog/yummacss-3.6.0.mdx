...
<Note icon="cursor">Try hovering the div to see how the opacity changes.</Note>

<Preview>
  <div className="bg-indigo-6/25 h:bg-indigo-6/100 b-1 bc-indigo-7/25 d-16"></div>
</Preview>

```html
<div class="bg-indigo-6/25 h:bg-indigo-6/100 b-1 bc-indigo-7/25 d-16"></div>
```

### Media variants with pseudo-classes

<Note icon="size">Try resizing the window to see how the opacity changes when hovered.</Note>

<Preview>
  <div className="bg-indigo-6/25 lg:h:bg-indigo/50 h:bg-indigo/25 b-1 bc-indigo-6/25 d-16"></div>
</Preview>
