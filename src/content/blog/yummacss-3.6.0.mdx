...
**This update might change existing features, make sure you check out the check out the [release notes](https://github.com/yumma-css/yumma-css/releases/tag/v3.6.0) before upgrading.**
...
<Preview>
  <div className="bg-indigo-6/25 h:bg-indigo-6/50 b-1 bc-indigo-7/25 d-16"></div>
</Preview>
