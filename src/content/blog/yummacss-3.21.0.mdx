export const meta = {
  ...
  date: "2026-03-16",
  description:
    "Extend your design system with configurable colors & breakpoints.",
...
<a class="c-link">Continue reading</a>
```
...
```mjs {4-6} title="yumma.config.mjs"
export default {
  theme: {
    screens: {
      tablet: "640px",
