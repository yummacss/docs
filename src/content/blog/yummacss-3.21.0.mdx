export const meta = {
  ...
  cover: "~",
  date: "2026-03-16",
  description: "Extend your design system with configurable colors and breakpoints.",
...
Update your configuration file to take advantage of the new features. Read the [Upgrading Guide](/docs/upgrading) for the full list of config changes.
