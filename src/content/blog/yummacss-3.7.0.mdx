...
**This update might change existing features, make sure you check out the [release notes](https://github.com/yumma-css/yumma-css/releases/tag/v3.7.0) before upgrading.**
...
<UtilityTable category="text" name="vertical-align" />

### Writing Mode utilities

<UtilityTable category="text" name="writing-mode" />
