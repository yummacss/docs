...
**This update might break your codebase, we highly suggest you checking out the [release notes](https://github.com/yumma-css/yumma-css/releases/tag/v2.0.0) before upgrading.**
