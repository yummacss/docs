...
<Tabs defaultValue="now">
  <TabsList>
    <TabsTab className="tc-white b-1 rad-0" style={{backgroundColor: '#21243f', borderColor: '#31365e' }} value="now">Now</TabsTab>
    <TabsTab className="tc-white b-1 rad-0" style={{backgroundColor: '#21243f', borderColor: '#31365e' }} value="previously">Previously</TabsTab>
  </TabsList>
