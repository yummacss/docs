...
<Preview>
  <div className="d-16 bg-indigo tp-a td-300 tdu-300 ttf-io h:t-s-80 h:bg-slate-7"></div>
</Preview>

```html "tp-a" "td-300" "tdu-300" "ttf-io"
<div class="d-16 bg-indigo tp-a td-300 tdu-300 ttf-io h:t-s-80 h:bg-slate-7"></div>
```

The new utilities include:
- `td-*` for `transition-delay` (steps of 50ms)
- `tdu-*` for `transition-duration` (steps of 50ms)
