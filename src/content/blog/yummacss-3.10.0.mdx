export const meta = {
  ...
  cover: "~",
  date: "2026-01-31",
  description: "We've revamped the color palette, added 11 new pseudo-class variants, introduced a new transitions category, and streamlined transforms with the new rotate shorthand.",
...
<Preview>
  <button className="bg-indigo p-px c-white br-0 tp-all td-300 ttf-io h:bg-indigo-3">
    Hover me
  </button>
</Preview>

```html "tp-a" "td-300" "ttf-io"
<button class="bg-indigo p-px c-white br-0 tp-a td-300 ttf-io h:bg-indigo-3">
  Hover me
</button>
```
...
We've updated our default font family variables to use more modern and comprehensive font stacks. This ensures your applications look great across all devices and operating systems by default.
