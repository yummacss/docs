...
```diff lang="html" del={1} ins={2} title="example.html"
<div class="br-2"></div>
<div class="br-sm"></div>
```
...
Update to the latest version to start using t-shirt sizing. Refer to the [Upgrade Guide](/docs/upgrading) for more details on migration.
