...
**This update shouldn't be difficult to upgrade, but you may want to check out the [release notes](https://github.com/yumma-lib/yumma-css/releases/tag/v3.2.0) before upgrading.**
...
<Preview>
    <button className="bg-indigo rad-9 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Subscribe</button>
</Preview>
...
<Preview>
    <div className="tc-blue">
      <svg className="h-10 w-10 f-current" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
