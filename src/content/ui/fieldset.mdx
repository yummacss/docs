...
<fieldset class="d-f fd-c g-4 w-full max-w-64 bw-0 m-0 p-0">
  <legend class="bbw-1 bc-silver-4 pb-3 fs-lg fw-500 c-slate-12">
    Billing details
  </legend>

  <div class="d-f fd-c ai-fs g-1">
    <label class="fs-sm fw-500 c-slate-12" for="company-input">Company</label>
    <input
      id="company-input"
      type="text"
      placeholder="Enter company name"
  ...
  <div class="d-f fd-c ai-fs g-1">
    <label class="fs-sm fw-500 c-slate-12" for="tax-input">Tax ID</label>
    <input
      id="tax-input"
      type="text"
      placeholder="Enter fiscal number"
