...
<Stepper>
  ...
  <Step title="Install Dependencies">
    ...
    ```bash title="yarn"
    yarn add yummacss @yummacss/vite @base-ui/react iconoir-react motion
    ```

    ```bash title="bun"
    bun add yummacss @yummacss/vite @base-ui/react iconoir-react motion
    ```
...
<Stepper>
  ...
  <Step title="Install Dependencies">
    ...
    ```bash title="yarn"
    yarn add yummacss @yummacss/postcss @base-ui/react iconoir-react motion
    ```

    ```bash title="bun"
    bun add yummacss @yummacss/postcss @base-ui/react iconoir-react motion
    ```
