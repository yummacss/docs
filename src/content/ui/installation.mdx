...
Components draw their icons from [Solar](https://github.com/480-Design/Solar-Icon-Set) by 480 Design, licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/), in its Linear style through `@solar-icons/react`.
