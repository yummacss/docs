...
<Preview id="checkbox-basic" className="bg-white" />
...
<Preview id="checkbox-checked" className="bg-white" />
...
<Preview id="checkbox-disabled" className="bg-white" />
...
<Preview id="checkbox-descriptive" className="bg-white" />
