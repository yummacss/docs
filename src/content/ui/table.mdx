...
<Preview className="bg-white">
   <div className="o-x-auto w-full b-1 bb-0 bc-silver-2 rad-1 bg-white">
      <table className="w-full ta-l bc-c">
         ...
         <tbody>
            <tr>
               ...
               <td className="bb-1 bc-silver-2 px-4 py-3 fs-sm tc-black">
                  <span className="d-if ai-c px-2 py- rad-1 fs-xs fw-500 bg-green-1/50 tc-green b-1 bc-green-2">Online</span>
               </td>
               ...
               <td className="bb-1 bc-silver-2 px-4 py-3 fs-sm tc-black ta-r">
                  <a href="#" className="tc-slate fw-500 td-none h:td-u">Edit</a>
               </td>
            </tr>
            <tr>
               <td className="bb-1 bc-silver-2 px-4 py-3 fs-sm tc-black">
               ...
               <td className="bb-1 bc-silver-2 px-4 py-3 fs-sm tc-black">
                  <span className="d-if ai-c px-2 py- rad-1 fs-xs fw-500 bg-red-1/50 tc-red b-1 bc-red-2">Offline</span>
               </td>
            ...
            <tr>
               ...
               <td className="bb-1 bc-silver-2 px-4 py-3 fs-sm tc-black ta-r">
                  <a href="#" className="tc-slate fw-500 td-none h:td-u">
                     <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 tc-slate-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
                  </a>
               </td>
            </tr>
            <tr>
