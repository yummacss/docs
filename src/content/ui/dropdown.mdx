...
<Preview id="dropdown-basic" className="bg-white h-100" />
...
<Preview id="dropdown-icons" className="bg-white h-100" />
...
<Preview id="dropdown-shortcuts" className="bg-white h-100" />
