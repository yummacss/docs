...
<Preview className="bg-white">
   <div className="d-ib">
      <button className="d-f ai-c g-2 px-4 py-2 rad-1 fs-sm fw-500 bg-white tc-slate-8 b-1 bc-silver-4 h:bg-silver-1 f:oc-silver-1 f:os-s f:ow-2">
         <span>Options</span>
      ...
      <div className="mt-1 p-1 bg-white b-1 bc-silver-4 rad-1 bs-3 min-w-40">
         <button className="d-b w-full ta-l px-3 py-2 rad-1 fs-sm tc-slate-8 bg-transparent b-0 h:bg-silver-1 cu-p">Edit</button>
         <button className="d-b w-full ta-l px-3 py-2 rad-1 fs-sm tc-slate-8 bg-transparent b-0 h:bg-silver-1 cu-p">Duplicate</button>
         <button className="d-b w-full ta-l px-3 py-2 rad-1 fs-sm tc-slate-8 bg-transparent b-0 h:bg-silver-1 cu-p">Archive</button>
         <hr className="my-1 b-0 bt-1 bc-silver-4" />
         <button className="d-b w-full ta-l px-3 py-2 rad-1 fs-sm tc-red bg-transparent b-0 h:bg-red-1 cu-p">Delete</button>
      </div>
   </div>
</Preview>
...
<Preview className="bg-white">
   <div className="d-ib">
      ...
      <div className="mt-1 p-1 bg-white b-1 bc-silver-4 rad-1 bs-3 min-w-44">
         <button className="d-f ai-c g-2 w-full ta-l px-3 py-2 rad-1 fs-sm tc-slate-8 bg-transparent b-0 h:bg-silver-1 cu-p">
         ...
         <hr className="my-1 b-0 bt-1 bc-silver-4" />
         <button className="d-f ai-c g-2 w-full ta-l px-3 py-2 rad-1 fs-sm tc-red bg-transparent b-0 h:bg-red-1 cu-p">
