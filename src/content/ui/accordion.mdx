   ...
   <div className="d-f fd-c">
      <details className="b-1 bc-silver-2 rad-t-1 bb-none">
         <summary className="p-4 c-p d-f jc-sb ai-c lst-none fw-600">
            <b className="tc-slate">Is Yumma CSS free?</b>
            <svg xmlns="http://www.w3.org/2000/svg" className="fs-lg tc-slate-8 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
         </summary>
      ...
      <details className="b-1 bt-0 bc-silver-2">
         <summary className="p-4 c-p d-f jc-sb ai-c lst-none fw-600">
            <b className="tc-slate">Can I use it with React?</b>
            <svg xmlns="http://www.w3.org/2000/svg" className="fs-lg tc-slate-8 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
         </summary>
         <div className="px-4 pb-4 tc-slate fs-sm lh-4">
      ...
      <details open className="b-1 bt-0 bc-silver-2 rad-b-1">
         <summary className="p-4 c-p d-f jc-sb ai-c lst-none fw-600">
            <b className="tc-slate">Is Yumma UI mobile friendly?</b>
            <svg xmlns="http://www.w3.org/2000/svg" className="fs-lg tc-slate-8 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
         </summary>
         <div className="px-4 pb-4 tc-slate fs-sm lh-4">
      ...
      <details className="b-1 bc-silver-2 rad-1">
         <summary className="p-4 c-p d-f jc-sb ai-c lst-none fw-600">
            <div className="d-f ai-c g-2">
               <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 tc-slate-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
               <b className="tc-slate">Is Yumma CSS free?</b>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" className="fs-lg tc-slate-8 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg>
         </summary>
