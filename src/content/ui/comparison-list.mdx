...
<div class="d-g gtc-2 g-8">
  <div>
    ...
    <div class="d-f fd-c g-3">
      <div class="d-f ai-c g-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 c-green" viewBox="0 0 256 256" aria-hidden="true">
          <rect width="256" height="256" fill="none" />
          <polyline points="40 144 96 200 224 72" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
        </svg>
  ...
  <div>
    ...
    <div class="d-f fd-c g-3">
      <div class="d-f ai-c g-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 c-red" viewBox="0 0 256 256" aria-hidden="true">
          <rect width="256" height="256" fill="none" />
          <line x1="200" y1="56" x2="56" y2="200" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
          <line x1="200" y1="200" x2="56" y2="56" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
        </svg>
