   ...
   <div className="py-16 px-6 ta-c">
      <div className="max-w-sm m-auto">
         ...
         <div className="d-f jc-c g-3">
            ...
            <button className="ai-c d-f jc-c g-2 px-5 py-3 rad-9 fs-md fw-600 bg-white tc-slate-8 h:bg-silver-1">
...
<Preview variant="noPadding" className="bg-white">
   <div className="py-16 px-6 ta-c">
      <div className="max-w-sm m-auto">
         ...
         <div className="d-f jc-c g-3">
            <button className="px-5 py-3 rad-9 fs-md fw-600 bg-slate-8 tc-white h:bg-slate-10 f:oc-silver-4 f:os-s f:ow-2">Start free trial</button>
            <button className="px-5 py-3 rad-9 fs-md fw-600 bg-white tc-slate-8 h:bg-silver-1">View demo</button>
         </div>
      </div>
   </div>
</Preview>
