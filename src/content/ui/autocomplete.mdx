    ...
    <Autocomplete.Root items={tags}>
      <label className="d-f fd-c g-1 fs-sm fw-500 c-slate">
        ...
        <Autocomplete.Input
          ...
          className="h-10 w-64 md:w-80 pl-4 br-1 bw-1 bc-silver-4 fs-sm c-slate bg-white fv:os-s fv:ow-2 fv:oo--1 fv:oc-blue-8 b-0"
        />
      </label>
          ...
          <Autocomplete.Popup className="w-64 md:w-80 max-h-72 br-1 bg-white bw-1 bc-silver-4 bs-lg c-slate o-h">
            ...
            <Autocomplete.List className="ow-0 o-y-auto py-2 max-h-72">
              {(tag: Tag) => (
                <Autocomplete.Item
                  key={tag.id}
                  className="d-f ai-c py-2 pr-8 pl-4 fs-sm c-d us-none"
                  value={tag}
                >
                  {tag.value}
                </Autocomplete.Item>
