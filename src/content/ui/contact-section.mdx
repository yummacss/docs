...
<Preview variant="noPadding" className="bg-white">
   <div className="py-12 px-6">
      ...
      <div className="d-g gtc-1 sm:gtc-3 g-6">
         <div className="p-6 b-1 b-d bs-sm bc-silver-4 rad-0">
...
<div class="py-12 px-6">
   ...
   <div class="d-g gtc-1 sm:gtc-3 g-6">
      <div class="p-6 b-1 b-d bs-sm bc-silver-4 rad-0">
         <div class="d-f ai-c jc-c d-10 rad-9 b-1 b-d bc-silver-4 bs-sm tc-slate mb-4">
      ...
      <div className="d-f fw-w g-12">
         <div className="f-1 min-w-64">
            ...
            <div className="d-f fd-c g-4">
               <div className="d-f ai-c g-3">
                  <div className="d-f ai-c jc-c d-10 rad-9 b-1 b-d bc-silver-4 bs-sm tc-slate-9">
                     <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                  </div>
                  <div>
         ...
         <div className="f-1 min-w-64">
            <form className="d-f fd-c g-4">
               ...
               <div className="d-f fd-c g-1">
                  <label className="fs-sm fw-600 tc-slate-9">Message</label>
                  <textarea placeholder="Your message" rows="4" className="w-full px-3 py-2 b-1 bc-silver-4 rad-0 fs-sm tc-black f:oc-silver-1 f:os-s f:ow-2 rz-n"></textarea>
               </div>
               <button type="submit" className="px-4 py-2 rad-0 fs-sm fw-600 bg-slate-8 tc-white h:bg-slate-10 f:oc-silver-4 f:os-s f:ow-2">Send message</button>
            </form>
         </div>
      </div>
   </div>
      ...
      <div class="f-1 min-w-64">
         <form class="d-f fd-c g-4">
            ...
            <div class="d-f fd-c g-1">
               ...
               <textarea placeholder="Your message" rows="4" class="w-full px-3 py-2 b-1 bc-silver-4 rad-0 fs-sm tc-black f:oc-silver-1 f:os-s f:ow-2 rz-n"></textarea>
            </div>
