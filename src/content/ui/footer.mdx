  ...
  <footer className="py-12 px-6 bt-1 bc-silver-4">
    <div className="d-f fw-w g-12 mb-10">
      <div className="f-2 min-w-48">
        <svg fill="none" viewBox="0 0 152 48" className="h-6 tc-silver-10 mb-4" xmlns="http://www.w3.org/2000/svg">
          <path
            clipRule="evenodd"
...
<footer class="py-12 px-6 bt-1 bc-silver-4">
  <div class="d-f fw-w g-12 mb-10">
    <div class="f-2 min-w-48">
      <svg fill="none" viewBox="0 0 152 48" class="h-6 tc-silver-10 mb-4" xmlns="http://www.w3.org/2000/svg">
        <path
          clip-rule="evenodd"
          d="m34.5868 8.40061-9.6868-2.59556c-.6687-.17919-1.2108.23679-1.2108.92911v10.02854c0 .6923.5421 1.3988 1.2108 1.578l9.6868 2.5955c.6687.1792 1.2109-.2368 1.2109-.9291v-10.02848c0-.69232-.5422-1.39882-1.2109-1.57801zm-9.6868-6.35625c-2.6749-.71674-4.8434.94718-4.8434 3.71647v10.02847c0 2.7693 2.1685 5.5953 4.8434 6.312l9.6868 2.5956c2.6749.7168 4.8434-.9472 4.8434-3.7165v-10.0284c0-2.76934-2.1685-5.59533-4.8434-6.31207z"
          fill="#8098f9"
