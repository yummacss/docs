...
<Preview id="footer-basic" variant="noPadding" className="bg-white" />
...
<Preview id="footer-columns" variant="noPadding" className="bg-white" />
...
<Preview id="footer-columns-with-logo" variant="noPadding" className="bg-white" />
