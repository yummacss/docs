...
<Preview id="avatar-circle" className="bg-white" />
...
<Preview id="avatar-initials" className="bg-white" />
...
<Preview id="avatar-indicator" className="bg-white" />
...
<Preview id="avatar-label" className="bg-white" />
