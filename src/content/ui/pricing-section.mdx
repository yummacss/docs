  ...
  <div className="py-12 px-6">
    ...
    <div className="d-f fw-w jc-c g-6">
      <div className="w-72 b-1 bc-silver-4 rad-0 p-6 d-f fd-c">
        ...
        <button className="mt-auto ai-c d-f jc-c px-4 py-2 rad-0 fs-sm fw-500 bg-white tc-slate-8 b-1 bc-silver-4 h:bg-silver-1 f:oc-silver-1 f:os-s f:ow-2">
          Get started
        </button>
      </div>
      <div className="w-72 b-2 bc-slate-8 rad-0 p-6 d-f fd-c">
        ...
        <button className="mt-auto ai-c d-f jc-c px-4 py-2 rad-0 fs-sm fw-500 bg-slate-8 tc-white h:bg-slate-10 f:oc-silver-4 f:os-s f:ow-2">
          Get started
        </button>
      </div>
    </div>
