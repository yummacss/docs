...
<Preview>
  <button className="bg-indigo rad-0 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Purchase</button>
</Preview>

```html
<button class="bg-indigo rad-0 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Purchase</button>
```
...
<Preview className="bg-silver-1">
  <div className="bg-white bs-sm d-f fd-c g-4 h-100 max-w-80 p-5">
    <div className="p-r">
      <span className="bg-black/70 fs-xs fw-700 l-2 p-a px-2 py-px rad-9 t-2 tc-white us-none">New</span>
      <img className="h-40 of-c w-full" src="/img/shoes.jpg" />
    </div>

    <div className="fs-xl fw-600 tc-slate">Sneakers</div>

    <p className="fs-sm tc-slate">Comfortable and stylish, these sneakers are perfect for any occasion.</p>

    <div className="ai-c d-f jc-sb mt-auto">
      <span className="fs-lg fw-700 tc-slate">$59.99</span>
      <button className="bg-black f:oc-black f:oo-2 f:os-s f:ow-2 fw-500 px-4 py-2 tc-white">Add to Cart</button>
    </div>
...
<div class="bg-white bs-lg d-f fd-c g-4 h-100 max-w-80 p-5">
  <div class="p-r">
    <span class="bg-black/70 fs-xs fw-700 l-2 p-a px-2 py-px rad-9 t-2 tc-white us-none">New</span>
    <img class="h-40 of-c w-full" src="/img/shoes.jpg" />
  </div>

  <div class="fs-xl fw-600 tc-slate">Sneakers</div>
  ...
  <div class="ai-c d-f jc-sb mt-auto">
    <span class="fs-lg fw-700 tc-slate">$59.99</span>
