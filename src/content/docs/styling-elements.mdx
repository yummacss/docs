...
<Preview>
  <button className="bg-indigo rad-1 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Get Started</button>
</Preview>

```html live
<button class="bg-indigo rad-1 b-0 tc-white c-p fw-600 py-1 px-5 h:bg-indigo-8">Get Started</button>
```
...
| `h:*`   | [hover:](/docs/foundations/pseudo-classes#hover)      |
...
<Preview className="bg-silver-1">
  <div className="bg-white bs-sm d-f fd-c g-4 h-100 max-w-80 p-5">
    ...
    <div className="fs-xl fw-600 tc-black">Sneakers</div>
    ...
    <div className="ai-c d-f jc-sb mt-auto">
      <span className="fs-lg fw-700 tc-black">$59.99</span>
...
<div class="bg-white bs-lg d-f fd-c g-4 h-100 max-w-80 p-5">
  ...
  <div class="fs-xl fw-600 tc-black">Sneakers</div>
...
| `f:*`     | [focus:](/docs/foundations/pseudo-classes#focus)      |
