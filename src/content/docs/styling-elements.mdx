...
<Preview>
  <button className="bg-indigo rad-1 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Purchase</button>
</Preview>

```html
<button class="bg-indigo rad-1 b-0 tc-white c-p fw-600 py-2 px-5 h:bg-indigo-8">Purchase</button>
```
