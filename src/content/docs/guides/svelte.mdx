...
description: Setup Yumma CSS with Svelte.
slug: docs/guides/svelte
---

## Creating a new project

To create a new Svelte project, you need run the [Svelte](https://svelte.dev/docs/cli/sv-create) command in your terminal.
