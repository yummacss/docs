...
The Alert component is composed of several sub-components that work together to create a structured alert message.

| Component          | Description                                                       | Props                                      |
| ------------------ | ----------------------------------------------------------------- | ------------------------------------------ |
| `AlertContent`     | A container that wraps the alert's title and description content. | Extends all native HTML `<div>` attributes |
| `AlertTitle`       | Displays the main heading or title of the alert message.          | Extends all native HTML `<h5>` attributes  |
| `AlertDescription` | Contains the detailed message or description text of the alert.   | Extends all native HTML `<div>` attributes |
