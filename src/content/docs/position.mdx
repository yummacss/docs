...
```html "p-s" layout="/src/layouts/inline.astro"
<div class="tc-white">
...
```html "p-a" layout="/src/layouts/inline.astro"
...
```html "p-r" layout="/src/layouts/inline.astro"
<div class="tc-white">
...
```html "p-st" layout="/src/layouts/inline.astro"
