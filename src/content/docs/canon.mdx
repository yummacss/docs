...
description: "Validate every class in your project against the Yumma CSS canon with @yummacss/canon."
---
...
Canon & [IntelliSense](/docs/intellisense) are built on the same validator, so a class flagged in one is flagged in the other. IntelliSense underlines it as you type; canon covers the cases an editor cannot, being files nobody has open & the pull request nobody has reviewed yet.
