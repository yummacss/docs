...
slug: docs/foundations/media-queries
---

## Breakpoints

By default, all base utilities can be used with responsive variants, making it easier to create responsive designs.
...
| Prefix | Min width                                                    |
| ------ | ------------------------------------------------------------ |
| sm     | <Code lang="css" code="@media (width >= 40rem) // 640px" />  |
| md     | <Code lang="css" code="@media (width >= 48rem) // 768px" />  |
| lg     | <Code lang="css" code="@media (width >= 64rem) // 1024px" /> |
| xl     | <Code lang="css" code="@media (width >= 80rem) // 1280px" /> |
| xxl    | <Code lang="css" code="@media (width >= 96rem) // 1536px" /> |
