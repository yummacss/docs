...
cover:
  ...
  image: cover.png
date: 2024-08-06
description: Yumma CSS Play a a code editor on the web with Yumma CSS built in based on Sandpack. Create your own Yumma CSS components and see them in action right away in your browser of choice.
...
![Yumma CSS Play - Zero Configuration](yummacss-playground-zero-config.png)

## Responsiveness

To test how responsive it is, just resize the preview panel.

![Yumma CSS Play - Responsiveness](yummacss-playground-responsiveness.png)

## Completions

Get some helpful tips on using semantic HTML tags when you're writing.

![Yumma CSS Play - Completions](yummacss-playground-completions.png)
