...
![Yumma Playground - Zero Configuration](../guides/images/yummacss-playground-zero-config.png)

## Responsiveness

To test how responsive it is, just resize the preview panel.

![Yumma Playground - Responsiveness](../guides/images/yummacss-playground-responsiveness.png)

## Completions

Get some helpful tips on using semantic HTML tags when you're writing.

![Yumma Playground - Completions](../guides/images/yummacss-playground-completions.png)
