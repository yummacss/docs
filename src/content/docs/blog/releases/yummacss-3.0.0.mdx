...
cover:
  alt: Yumma CSS 3.0
  image: ./covers/yummacss-3.0.0.png
date: 2025-04-02
excerpt: After almost six months of hard work it's finally here — Yumma CSS v3.0 🎉
pagefind: false
slug: blog/yummacss-3.0
tags: ["release"]
title: Yumma CSS 3.0 - All-new CLI, utilities, and more
---
...
<iframe
  ...
  src="https://www.youtube-nocookie.com/embed/eqTIFRGqp9o?si=XoT9rd2OwI0GPyHu"
...
- [All-new utilities](#all-new-utilities): Over 50 new utility classes.
...
<Steps>
    ...
    1. **Install Yumma CSS**
        ...
        <Decorator icon="info">Learn more about [dependency changes](#dependency-changes).</Decorator>

        <PackageManagers pkg="yummacss" args="--save-dev" title="Terminal" />
...
<div class="p-4">
  ```diff lang="html" title="index.html" - <button class="bg-l-indigo-6 h:bg-d-indigo-1">Hello</button>+ <button class="bg-indigo-1 h:bg-indigo-7">Hello</button>
  ```
</div>
...
<Tabs>
  <TabItem label="Bottom">
    ```diff lang="html" "bo-* " title="index.html"
    - <div class="dir-b-* ..."></div>
    + <div class="bo-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Left">
    ```diff lang="html"  "l-* " title="index.html"
    - <div class="dir-l-* ..."></div>
    + <div class="l-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Right">
    ```diff lang="html"  "r-* " title="index.html"
    - <div class="dir-r-* ..."></div>
    + <div class="r-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Top">
    ```diff lang="html"  "t-* " title="index.html"
    - <div class="dir-t-* ..."></div>
    + <div class="t-* ..."></div>
    ```
  </TabItem>
...
```diff lang="html" "c-*" title="index.html"
- <div class="cols-* ..."></div>
+ <div class="c-* ..."></div>
```
...
```diff lang="html" "d-*" title="index.html"
- <div class="dim-* ..."></div>
+ <div class="d-* ..."></div>
```
