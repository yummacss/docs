...
3. **Create configuration file**
   ...
   Learn more about how to set up the configuration file [here](/docs/foundations/config/#creating-your-configuration-file).
...
<PackageManagers pkgManagers={["pnpm", "npm", "yarn"]} icons={false} pkg="yummacss" type="exec" args="watch" title="Terminal" />
