...
<iframe
  ...
  src="https://youtube.com/embed/n0tSAaHZTiw?si=AwWogjY861eJCqlt"></iframe>
...
![Yumma CSS Intellisense - Media Query Hover](intellisense-breakpoint-hover.png)

## Pseudo classes

The same goes for pseudo class utility variants like `h:*`.

![Yumma CSS Intellisense - Pseudo Class Hover](intellisense-pseudo-hover.png)
