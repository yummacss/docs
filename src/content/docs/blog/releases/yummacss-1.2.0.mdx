...
Previously, the colors weren't as rich as we wanted them to be, which was a bit of a limitation because colors with less contrast can go unnoticed in many scenarios. we thought I'd show you the difference between the old and new color palettes in Yumma CSS v1.2.
