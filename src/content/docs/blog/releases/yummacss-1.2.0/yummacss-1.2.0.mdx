...
cover:
  ...
  image: cover.png
date: 2024-03-21
description: We've been planning to revamp the color palette of Yumma CSS for a while, happy to announce the new version [Yumma CSS v1.2.0](https://github.com/yumma-lib/yumma-css/releases/tag/v1.2.0)! It has a reworked color palette, new variants for dimension utilities, line-height utilities, and more.
pagefind: false
...
We've been planning to revamp the color palette of Yumma CSS for a while, happy to announce the new version [Yumma CSS v1.2.0](https://github.com/yumma-lib/yumma-css/releases/tag/v1.2.0)! It has a reworked color palette, new variants for dimension utilities, `line-height` utilities, and more.
