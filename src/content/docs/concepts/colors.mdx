...
Use `[class]-l-*` like `bg-l-indigo-3` to get a lighter color.

```html live "bg-l-cyan-3"
<button class="b-0 bg-l-cyan-3 fw-600 px-5 py-1 rad-1 tc-white">Subscribe</button>
```

### Dark color

Use `[class]-d-*` like `bg-d-indigo-3` to get a darker color.

```html live "bg-d-cyan-3"
<button class="b-0 bg-d-cyan-3 fw-600 px-5 py-1 rad-1 tc-white">Subscribe</button>
```
