...
Using `defineConfig` automatically enables IntelliSense. Alternatively, you can add a JSDoc comment at the top of your configuration file.
...
```mjs title="yumma.config.mjs" mark={5}
import { defineConfig } from "yummacss";
