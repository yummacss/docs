...
<Preview className="bg-white" variant="inline">
  <p className="fs-xs ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-sm ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-md ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-lg ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-xxl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-3xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-4xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-5xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-6xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-7xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-8xl ta-c tc-slate">Aa</p>
</Preview>
...
<Preview className="bg-white" variant="inline">
  <p className="fs-9xl ta-c tc-slate">Aa</p>
</Preview>
