...
<Stepper>
  <Step title="Install Yumma CSS">
    ...
    ```bash title="yarn"
    yarn add yummacss @yummacss/vite -D
    ```

    ```bash title="bun"
    bun add yummacss @yummacss/vite -d
    ```
...
<Stepper>
  <Step title="Install Yumma CSS">
    ...
    ```bash title="yarn"
    yarn add yummacss @yummacss/postcss -D
    ```

    ```bash title="bun"
    bun add yummacss @yummacss/postcss -d
    ```
