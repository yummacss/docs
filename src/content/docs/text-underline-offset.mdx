...
```html "tuo-auto" layout="/src/layouts/inline.astro"
...
```html "tuo-0" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tuo-1" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tuo-2" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tuo-4" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tuo-8" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
