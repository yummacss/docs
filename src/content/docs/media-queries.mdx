...
```mjs title="yumma.config.mjs" mark={5-11}
...
Using custom breakpoints works exactly the same as the defaults:

```html
<div class="tablet:bg-blue desktop:bg-red 3xl:bg-green"></div>
```
