...
<Preview>
  <div className="h-32 w-full ta-px ov-s">
    <div className="w-128 p-4 bg-indigo/10 br-1">
...
<Preview>
  <div className="h-32 w-full ta-py ov-s">
    <div className="h-64 p-4 bg-indigo/10 br-1">
