...
<Preview>
  <div className="bw-3 bs-d bc-bb bc-indigo-8 bg-indigo w-20 h-20 p-2"></div>
</Preview>
...
<Preview>
  <div className="bw-3 bs-d bc-cb bc-indigo-8 bg-indigo w-20 h-20 p-2"></div>
</Preview>
...
<Preview>
  <div className="bw-3 bs-d bc-indigo-8 bc-pb bg-indigo w-20 h-20 p-2"></div>
</Preview>
...
<Preview>
  <div className="bc-t fs-3xl fw-700 o-h px-4 py-2 br-2 c-transparent" style={{ backgroundImage: "linear-gradient(132deg, #413cb8 0.00%, #7a77cd 100.00%)" }}>
