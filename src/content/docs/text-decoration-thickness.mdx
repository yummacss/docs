...
```html "tdt-auto" layout="/src/layouts/inline.astro"
...
```html "tdt-0" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tdt-1" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tdt-2" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tdt-3" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
```html "tdt-4" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
