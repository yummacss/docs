...
We're making some changes to Stylecent in v3 to make it more modern and consistent. These changes are turned on by default, but you can turn them off using the [`yummacss.config.js`](#core-changes) file.
...
### Border Bottom / Left/ Right/ Top Radius utilities
