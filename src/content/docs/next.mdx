...
<Steps>
    ...
    5. **Compile the SCSS**
        ...
        Whenever you run "npx yummacss build," the CLI will rescan the whole project to make sure you're always compiling what your project is using. This also gets rid of any useless utilities in your codebase.
