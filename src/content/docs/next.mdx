...
We completely overhauled the codebase to get better performance in build times and overall file size.
...
Rather, this new version involved a complete rewrite of the codebase, from the way utilities and modifiers are generated, to eliminate any potential for duplicated or unnecessary data in the `/dist` folder.
