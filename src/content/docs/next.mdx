...
The color system is getting some big changes. We've gone from `10%` shade modification to `15%`. This means that light colors are going to be even lighter and dark colors are going to be even darker.
