...
<Steps>
    ...
    3. **Set up the config file**
        ...
        To build the CSS from the source include the `source` array and the `styles` string options inside a config named object.
    ...
    4. **Write CSS**
        ...
        ```html mark={7, 11-16} title="page.html"
        <!DOCTYPE html>
        <html lang="en">
...
<Decorator icon="info_circled">We've run our build process three times in a row and the results are as follows:</Decorator>
...
1.  **Remove `@import` rules**
    ...
    ```diff lang="css" title="src/globals.css" title="page.html"
...
```diff lang="html" title="page.html"
...
```diff lang=scss mark={2-3} title="base/stylecent.scss" title="page.html"
body {
...
```diff lang="html" "rad-b-2" title="page.html"
...
```diff lang="html" "rad-l-2" title="page.html"
...
```diff lang="html" "rad-r-2" title="page.html"
...
```diff lang="html" "rad-t-2" title="page.html"
...
<Tabs>
  <TabItem label="Bottom">
    ```diff lang="html" "bo-* " title="page.html"
    - <div class="dir-b-* ..."></div>
    + <div class="bo-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Left">
    ```diff lang="html"  "l-* " title="page.html"
    - <div class="dir-l-* ..."></div>
    + <div class="l-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Right">
    ```diff lang="html"  "r-* " title="page.html"
    - <div class="dir-r-* ..."></div>
    + <div class="r-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Top">
    ```diff lang="html"  "t-* " title="page.html"
    - <div class="dir-t-* ..."></div>
    + <div class="t-* ..."></div>
    ```
  </TabItem>
...
```diff lang="html" "c-*" title="page.html"
- <div class="cols-* ..."></div>
+ <div class="c-* ..."></div>
```
...
```diff lang="html" "d-*" title="page.html"
- <div class="dim-* ..."></div>
+ <div class="d-* ..."></div>
```
...
```diff lang="html" title="page.html"
- <div class="h-1/1 ...">A</div>
- <div class="w-1/1 ...">A</div>
- <div class="d-1/1 ...">A</div>
+ <div class="h-dvh ...">A</div>
+ <div class="w-dvh ...">A</div>
+ <div class="d-dvh ...">A</div>
```
...
```live "cg-8" title="page.html"
<div class="d-if fd-r cg-8 stripes tc-white">
...
```live "rg-8" title="page.html"
<div class="d-if fd-c cg-8 stripes tc-white">
  <div class="ai-c bg-indigo d-f dim-16 jc-c rad-1">A</div>
  <div class="ai-c bg-indigo d-f dim-16 jc-c rad-1">B</div>
  <div class="ai-c bg-indigo d-f dim-16 jc-c rad-1">C</div>
</div>
