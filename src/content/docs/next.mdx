...
Yumma CSS Next didn't solely focus on external improvements. Rather, this new version involved a complete rewrite of the codebase, from the way utilities and modifiers are generated, to eliminate any potential for duplicated or unnecessary data in the `/dist` folder.
