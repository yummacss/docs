...
<Tabs>
  <TabItem label="Bottom">
    ```diff lang="html" title="app.html" - <div class="dir-b-* ..."></div>
    <div class="bo-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Left">
    ```diff lang="html" title="app.html" - <div class="dir-l-* ..."></div>
    <div class="l-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Right">
    ```diff lang="html" title="app.html" - <div class="dir-r-* ..."></div>
    <div class="r-* ..."></div>
    ```
  </TabItem>
  <TabItem label="Top">
    ```diff lang="html" title="app.html" - <div class="dir-t-* ..."></div>
    <div class="t-* ..."></div>
    ```
  </TabItem>
</Tabs>
