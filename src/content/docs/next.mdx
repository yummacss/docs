...
We're removing the ins utility class from Yumma. It's been a great ride, and we're sure most of you have used it to easily center a div in the middle of the screen. But to keep things modern and flexible, this concept doesn't fit into the framework, so we've decided to remove it.
