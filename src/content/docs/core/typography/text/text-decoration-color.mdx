...
<div class="bg-indigo-1 p-4 rad-1">
  <div class="bg-white p-4 rad-1 ta-j tc-lead">
    ...
    you gave me for my birthday. I've been a little under the weather lately, but <span class="h:bg-teal-1 tdc-yellow tdl-u tdt-2">I'll bounce back</span> in no time so we can meet
...
<HoverModifier class="tdc-lead" hoverModifier="tdc-teal" prefixClass="tdc">
  ### Hover modifier
</HoverModifier>
