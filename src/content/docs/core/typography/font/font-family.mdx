...
<Note icon="heart">Yumma CSS uses the `vars.$yma-font-system` as a default `font-family`. Learn more about it in the [docs](/docs/foundations/base-styles#document).</Note>
