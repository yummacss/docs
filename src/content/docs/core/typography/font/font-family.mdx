...
<div class="bg-l-indigo-6 p-4 rad-1">
  <div class="bg-white ff-c fs-sm p-4 rad-1 ta-c tc-lead">The quick brown fox jumps over the lazy dog.</div>
</div>
```
...
<div class="bg-l-indigo-6 p-4 rad-1">
  <div class="bg-white ff-m fs-sm p-4 rad-1 ta-c tc-lead">The quick brown fox jumps over the lazy dog.</div>
</div>
```
...
<div class="bg-l-indigo-6 p-4 rad-1">
  <div class="bg-white ff-s fs-sm p-4 rad-1 ta-c tc-lead">The quick brown fox jumps over the lazy dog.</div>
</div>
```
