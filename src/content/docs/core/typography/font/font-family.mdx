...
<Decorator icon="heart">Stylecent uses the `vars.$yma-font-system` as a default `font-family`. Learn more about it in the [docs](/docs/stylecent#document).</Decorator>
