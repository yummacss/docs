...
```html live "fs-b" layout="/src/layouts/inline.astro"
<div class="bg-indigo-1 p-4 rad-1">
...
<MediaModifier class="fs-md" mediaModifier="fs-lg" prefixClass="fs">
  ### Media modifier
</MediaModifier>

<HoverModifier class="fs-md" hoverModifier="fs-lg" prefixClass="fs">
  ### Hover modifier
</HoverModifier>
