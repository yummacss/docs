...
This example showcases various stroke width utilities: **0.2**, **0.6**, and **1**.

- The **sw-2** stroke width utility sets the stroke width to **0.2**.
- The **sw-6** stroke width utility sets the stroke width to **0.6**.
- The **sw-1** stroke width utility sets the stroke width to **1**.
