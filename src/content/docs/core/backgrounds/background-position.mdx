...
This example showcases various background position utilities: **bottom**, **center**, **left**, **right** and **top**.

- The **bottom** background position utility aligns the background image to the bottom edge of the element.
- The **center** background position utility centers the background image within the element.
- The **left** background position utility aligns the background image to the left edge of the element.
- The **right** background position utility aligns the background image to the right edge of the element.
- The **top** background position utility aligns the background image to the top edge of the element.
