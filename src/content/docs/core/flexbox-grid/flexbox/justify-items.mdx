...
<div class="ovf-auto p-8 p-r rad-3">
  <div class="area d-g g-4 gtc-3 ji-c tc-white">
...
<div class="ovf-auto p-8 p-r rad-3">
  <div class="area d-g g-4 gtc-3 ji-e tc-white">
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">A</div>
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">B</div>
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">C</div>
  </div>
...
```html live layout="/src/layouts/wide.astro"
<div class="ovf-auto p-8 p-r rad-3">
  <div class="area d-g g-4 gtc-3 ji-s tc-white">
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">A</div>
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">B</div>
    <div class="ai-c bg-indigo d-f dim-14 jc-c rad-2">C</div>
  </div>
...
```html live layout="/src/layouts/wide.astro"
<div class="ovf-auto p-8 p-r rad-3">
  <div class="area d-g g-4 gtc-3 ji-st tc-white">
