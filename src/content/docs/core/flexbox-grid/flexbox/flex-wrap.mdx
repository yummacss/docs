...
<div class="ovf-auto p-8 p-r rad-3">
  <div class="stripes d-f fw-nw g-4 max-w-30 rad-2 tc-white">
...
```html live "fw-w"
<div class="ovf-auto p-8 p-r rad-3">
  <div class="stripes d-f fw-w g-4 max-w-30 rad-2 tc-white">
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">A</div>
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">B</div>
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">C</div>
  </div>
...
```html live "fw-wr"
<div class="ovf-auto p-8 p-r rad-3">
  <div class="stripes d-f fw-wr g-4 max-w-30 rad-2 tc-white">
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">A</div>
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">B</div>
    <div class="ai-c bg-indigo d-f jc-c p-4 rad-2">C</div>
  </div>
