...
<Decorator icon="size">Try resizing the text area to see how it changes in size.</Decorator>
...
<MediaModifier class="r-none" mediaModifier="r-h" prefixClass="r">
  ### Media modifier
</MediaModifier>

<HoverModifier class="r-none" hoverModifier="r-h" prefixClass="r">
  ### Hover modifier
</HoverModifier>
