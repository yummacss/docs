...
This example showcases various border widths: **1px**, **2px**, **3px** and **4px**.

- The **1px** width creates a thin border
- The **2px** width creates a medium border
- The **3px** width creates a thick border  
- The **4px** width creates an extra thick border

```html live "b-1" "b-2" "b-3" "b-4"
<div class="d-g g-16 gtc-1 sm:gtc-3">
  <div class="ai-c b-1 bc-indigo d-f d-16 jc-c tc-indigo">A</div>
  <div class="ai-c b-2 bc-indigo d-f d-16 jc-c tc-indigo">B</div>
  <div class="ai-c b-3 bc-indigo d-f d-16 jc-c tc-indigo">C</div>
</div>
```
