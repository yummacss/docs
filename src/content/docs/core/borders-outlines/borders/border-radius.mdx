...
This example showcases various border-radius utilities: **rad-100** and **rad-half**.

- The **rad-full** utility sets the border radius to **100%**.
- The **rad-half** utility sets the border radius to **50%**.
