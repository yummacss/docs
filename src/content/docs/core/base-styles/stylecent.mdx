...
| Relative Import            | Base Styles |
| -------------------------- | ----------- |
| `\dist\yumma.css`          | Yes         |
| `\dist\yumma.min.css`      | Yes         |
| `\dist\yumma-core.css`     | No          |
| `\dist\yumma-core.min.css` | No          |

### Disabling Stylecent

To disable Stylecent using standard import, you can delete the `-core` from the import.

```css title="src/globals.css" del="-core"
/* Standard */
@import url("https://cdn.jsdelivr.net/gh/yumma-lib/yumma-css@latest/dist/yumma-core.css");

/* Minified */
@import url("https://cdn.jsdelivr.net/gh/yumma-lib/yumma-css@latest/dist/yumma-core.min.css");
```
