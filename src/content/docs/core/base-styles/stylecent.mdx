...
To disable specific styles, you can use the [`buildOptions.reset`](/docs/first-steps#buildoptionsreset) option and set it to `false` in your configuration file.
