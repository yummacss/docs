...
To disable Stylecent completely, simply add the [`buildOptions.reset`](/docs/first-steps#buildoptionsreset) option and set it to `false` in your `yumma.config.js` file.
