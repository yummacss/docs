...
<Class category="boxModel" name="width" />
...
<Class category="boxModel" name="max-width" />
...
<Class category="boxModel" name="min-width" />
...
<BreakpointVariant class="w-1" variant="w-2" classPrefix="w">
  ### Breakpoint variant
</BreakpointVariant>
