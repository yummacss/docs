...
<Decorator icon="cursor_arrow">Try scrolling through the container to see how the sticky position works.</Decorator>
...
<MediaModifier class="p-a" mediaModifier="p-s" prefixClass="p">
  ### Media modifier
</MediaModifier>

<HoverModifier class="p-a" hoverModifier="p-s" prefixClass="p">
  ### Hover modifier
</HoverModifier>
