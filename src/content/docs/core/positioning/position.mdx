...
<div class="tc-white">
  <div class="bg-l-indigo-5 h-32 p-4 p-r">
...
```html "p-f" layout="/src/layouts/wide.astro"
<div class="tc-white">
  <div class="bg-indigo dir-r-4 dir-t-4 p-4 p-f">Fixed Position</div>
  <div class="bg-d-indigo-3 h-screen p-4">Scroll down to see the fixed element.</div>
</div>
```
...
<Decorator name="mouse">Try scrolling through the container to see how the sticky position works.</Decorator>
