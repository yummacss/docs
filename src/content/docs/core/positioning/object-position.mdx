...
This example showcases various object positions: **bottom**, **center**, **left**, **right** and **top**.

- The **bottom** position aligns the object to the bottom edge of the container.
- The **center** position centers the object within the container.
- The **left** position aligns the object to the left edge of the container.
- The **right** position aligns the object to the right edge of the container.
- The **top** position aligns the object to the top edge of the container.
