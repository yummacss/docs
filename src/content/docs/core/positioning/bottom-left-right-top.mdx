...
<Utility additionalClasses={[{ name: "none", value: "none" }]} classPrefix="dir-b-" incrementValue={0.25} propNames={["bottom"]} range={16} />
...
<Utility additionalClasses={[{ name: "none", value: "none" }]} classPrefix="dir-i-" incrementValue={0.25} propNames={["inset"]} range={16} />
...
<Utility additionalClasses={[{ name: "none", value: "none" }]} classPrefix="dir-l-" incrementValue={0.25} propNames={["left"]} range={16} />
...
<Utility additionalClasses={[{ name: "none", value: "none" }]} classPrefix="dir-r-" incrementValue={0.25} propNames={["right"]} range={16} />
...
<Utility additionalClasses={[{ name: "none", value: "none" }]} classPrefix="dir-t-" incrementValue={0.25} propNames={["top"]} range={16} />
