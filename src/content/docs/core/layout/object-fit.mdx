...
```html live "of-c"
<div class="ovf-auto stripes p-r rad-1">
  <img class="h-24 mx-auto of-c ovf-h rad-2 ta-c w-48" src="https://picsum.photos/id/870/300/300" />
</div>
```
...
```html live "of-f"
<div class="ovf-auto stripes p-r rad-1">
<img class="h-24 mx-auto of-f ovf-h rad-2 ta-c w-48" src="https://picsum.photos/id/870/300/300" />
</div>
```
...
```html live "of-none"
<div class="ovf-auto stripes p-r rad-1">
  <img class="h-24 mx-auto of-none ovf-h rad-2 ta-c w-48" src="https://picsum.photos/id/870/300/300" />
</div>
```
...
```html live "of-sd"
<div class="ovf-auto stripes p-r rad-1">
  <img class="h-24 mx-auto of-sd ovf-h rad-2 ta-c w-48" src="https://picsum.photos/id/870/300/300" />
</div>
```
