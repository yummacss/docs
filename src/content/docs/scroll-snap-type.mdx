...
```html "sst-none" layout="/src/layouts/inline.astro"
<div class="o-h p-r">
...
```html "sst-b-m" layout="/src/layouts/inline.astro"
<div class="o-h p-r">
...
```html "sst-x-m" layout="/src/layouts/inline.astro"
<div class="o-h p-r">
...
```html "sst-x-p" layout="/src/layouts/inline.astro"
<div class="o-h p-r">
