...
<Preview className="bg-white">
  <div className="d-g g-4 max-w-64 mx-auto">
    <div className="fs-xl fw-600 tc-slate tw-w">Bleak House by Charles Dickens</div>
    <div className="fs-sm tc-gray-7">{bleakHouse}</div>
  </div>
</Preview>
...
<Preview className="bg-white">
  <div className="d-g g-4 max-w-64 mx-auto">
    <div className="fs-xl fw-600 tc-slate tw-b">Bleak House by Charles Dickens</div>
    <div className="fs-sm tc-gray-7">{bleakHouse}</div>
  </div>
</Preview>
...
<Preview className="bg-white">
  <div className="d-g g-4 max-w-64 mx-auto">
    <div className="fs-xl fw-600 tc-slate tw-nw">Bleak House by Charles Dickens</div>
    <div className="fs-sm tc-gray-7">{bleakHouse}</div>
  </div>
</Preview>
...
<Preview className="bg-white">
  <div className="d-g g-4 max-w-64 mx-auto">
    <div className="fs-xl fw-600 tc-slate tw-p">Bleak House by Charles Dickens</div>
    <div className="fs-sm tc-gray-7">{bleakHouse}</div>
  </div>
</Preview>
