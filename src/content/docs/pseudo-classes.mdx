...
<Preview registryId="pseudo-classes-active" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-active" "a:bg-indigo-7"
```
...
<Preview registryId="pseudo-classes-focus" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-focus" "f:oc-indigo-4" "f:oo-2" "f:os-s" "f:ow-2"
```
...
<Preview registryId="pseudo-classes-hover" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-hover" "h:bg-indigo-7"
```
...
<Preview registryId="pseudo-classes-focus-visible" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-focus-visible" "fv:ow-2" "fv:oc-indigo-4" "fv:oo-2"
```
...
<Preview registryId="pseudo-classes-focus-within" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-focus-within" "fw:oc-indigo-6"
```
...
<Preview registryId="pseudo-classes-checked" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-checked" "c:bg-indigo-4"
```
...
<Preview registryId="pseudo-classes-disabled" className="mb-2 br-md" />

```tsx registryId="pseudo-classes-disabled" "d:bg-silver-1" "d:c-silver-8"
```
