...
```html "br-r" layout="/src/layouts/inlineLightOnly.astro"
...
```html "br-nr" layout="/src/layouts/inlineLightOnly.astro"
...
```html "br-ro" layout="/src/layouts/inlineLightOnly.astro"
...
```html "br-rx" layout="/src/layouts/inlineLightOnly.astro"
...
```html "br-ry" layout="/src/layouts/inlineLightOnly.astro"
...
```html "br-s" layout="/src/layouts/inlineLightOnly.astro"
