...
You can name query containers using the `container-name` property. While Yumma CSS doesn't provide a direct utility for naming, you can apply it via the `style` attribute or custom CSS.

```html "container-name: sidebar"
<div class="ct-is" style="container-name: sidebar">
  <!-- Children can target this specific container -->
</div>
```
