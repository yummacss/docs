...
<Preview className="bg-white">
  <div className="d-f fd-c">
    ...
    <textarea className="b-1 r-none" rows={4}></textarea>
  </div>
</Preview>
...
<Preview className="bg-white">
  <div className="d-f fd-c">
    <label className="mb-2 tc-slate">Write a message:</label>
    <textarea className="b-1 max-h-50 max-w-100 r-b" rows={4}></textarea>
  </div>
</Preview>
...
<Preview className="bg-white">
  <div className="d-f fd-c">
    <label className="mb-2 tc-slate">Write a message:</label>
    <textarea className="b-1 max-w-100 r-h" rows={4}></textarea>
  </div>
</Preview>
