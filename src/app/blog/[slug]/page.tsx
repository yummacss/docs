      ...
      <article className="py-8 @lg:gc-s-8">
        <header className="mb-12">
          <div className="d-f ai-c g-2 mb-4 mt-16 c-foreground/50 fs-sm">
            <Link href="/blog" className="h:c-foreground fv:oc-foreground fv:ow-2">
              Blog
            </Link>
            <span>/</span>
          ...
          <h1 className="mb-2 c-foreground fs-4xl fw-400 @lg:fs-5xl">
            {post?.title}
          </h1>
            ...
            <div className="d-f ai-c g-4 c-foreground/70 fs-lg">
              <div className="d-f ai-c g-2">
                ...
                <Link
                  ...
                  className="c-foreground/70 h:c-foreground fv:oc-foreground fv:ow-2"
                >
                  {author.name}
                </Link>
              </div>
