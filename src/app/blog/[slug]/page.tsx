    ...
    <>
      <article className="py:8 @lg:gc-s:8">
        <header className="mb:12">
          <div className="d:f ai:c g:2 mb:4 mt:16 c:ink/50 fs:sm">
            <Link href="/blog" className="h:c:ink fv:oc:ink fv:ow:2">
              Blog
            </Link>
            <span>/</span>
          ...
          <p className="mb:6 c:ink/70 fs:lg lh:5">{post?.description}</p>

          {author && (
            <div className="d:f ai:c g:4 c:ink/70 fs:lg">
              <div className="d:f ai:c g:2">
                ...
                <Link
                  ...
                  className="c:ink/70 h:c:ink fv:oc:ink fv:ow:2"
                >
                  {author.name}
                </Link>
              </div>
