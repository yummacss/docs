      ...
      >
        <div className="w-full" style={{ maxWidth: "72rem" }}>
          <div className="d-g lg:gtc-2 g-12 ai-fe">
            <div>
              <div className="d-if ai-c g-2 px-4 py-2 bg-white/10 bf-b-md b-1 bc-white/5 rad-1 mb-8 tt-u">
                <span className="w-3 h-3 bg-green-5 rad-9"></span>
                <span className="fs-xs fw-500 ls-4">
                  Yumma CSS 3.5 is now live!
                </span>
              </div>
