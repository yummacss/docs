...
const uiRegistry = {
  ...
  "button-add-to-board": dynamic(() => import("./ui/button-add-to-board"), { ssr: true }),
  "button-add-to-sprint": dynamic(() => import("./ui/button-add-to-sprint"), { ssr: true }),
  ...
  "drawer-bottom": dynamic(() => import("./ui/drawer-bottom-sheet"), { ssr: true }),
