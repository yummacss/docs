    ...
    <AlertDialog.Root>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Popup className="p-f t-half l-half w-96 bw-1 bc-silver-4 br-1 bg-silver-1 p-6 c-slate alert-dialog-popup">
          <AlertDialog.Title className="fs-xl fw-500 mb-1 mt--1">
            Discard draft?
          </AlertDialog.Title>
          ...
          <div className="d-f jc-fe g-4">
            <AlertDialog.Close className="d-f ai-c jc-c h-10 bw-1 bc-silver-4 br-1 bg-silver-1 px-4 fs-md fw-500 c-slate-12 us-none h:bg-silver-2 fv:os-s fv:ow-2 fv:oo--1 fv:oc-blue-8 c-p b-0">
              Cancel
            </AlertDialog.Close>
