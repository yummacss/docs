    ...
    <div className="d-f fd-c g-6 ai-c o-s">
      {sizes.map((s) => (
        <div key={s.id} className="d-f ai-c g-6 fw-w">
          ...
          <Button className={`d-if ai-c ${s.padding} bg-white h:bg-silver-1 bc-silver-3 c-slate-10 ${s.br} bw-1 fw-500 bs-o-xs tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-indigo-5 ${s.text}`}>
            {s.label}
          </Button>

          <Button className={`d-if ai-c ${s.padding} bg-slate-1 h:bg-silver-2 c-slate-10 ${s.br} bw-0 fw-500 tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-indigo-5 ${s.text}`}>
            {s.label}
          </Button>
