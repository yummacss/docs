...
export default function AccordionOutset() {
  const [value, setValue] = useState<string[]>([]);

  return (
    <Accordion.Root
      className="d-f fd-c w-100% max-w-96 bg-white br-lg bw-1 bc-silver-2 bs-o-xs"
      value={value}
        ...
        return (
          ...
          >
            <Accordion.Header className="m-0">
              <Accordion.Trigger className="d-f ai-c jc-sb g-3 w-100% py-4 px-4 bg-transparent bw-0 br-sm ta-l c-p fv:oo-1 fv:oc-indigo-5">
            ...
            >
              <p className="m-0 pb-4 px-4 c-slate-6 fs-sm lh-4">{item.content}</p>
            </Accordion.Panel>
          </Accordion.Item>
        );
      })}
