...
export default function SelectLg() {
  ...
  return (
    <Field.Root className="d-f fd-c g-2">
      <label htmlFor="select-lg" className="c-slate-10 fs-sm fw-500 us-none">
        Task Status
      </label>
      <Select.Root defaultValue={null} open={open} onOpenChange={setOpen}>
        <Select.Trigger
          id="select-lg"
          className={`d-f ai-c jc-sb h-12 w-72 bw-1 bc-silver-3 br-lg bg-white px-4 c-slate-10 us-none c-p fv:oo--1 fv:oc-indigo-5 ${
            ...
            <Select.Portal>
              ...
              >
                <Select.Popup
                  ...
                  className="py-1 w-72 bg-white bc-silver-2 bw-1 br-lg"
                >
