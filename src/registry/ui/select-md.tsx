...
export default function SelectMd() {
  const [open, setOpen] = useState(false);

  return (
    <Field.Root className="d-f fd-c g-2">
      <label htmlFor="select-md" className="c-slate-10 fs-sm fw-500 us-none">
        Task Status
      </label>
      <Select.Root defaultValue={null} open={open} onOpenChange={setOpen}>
        <Select.Trigger
          id="select-md"
          className={`d-f ai-c jc-sb h-9 w-64 bw-1 bc-silver-3 br-lg bg-white px-3 c-slate-10 us-none c-p fv:oo--1 fv:oc-indigo-5 ${
            ...
            <Select.Portal>
              ...
              >
                <Select.Popup
                  ...
                  className="py-1 w-64 bg-white bc-silver-2 bw-1 br-lg"
                >
