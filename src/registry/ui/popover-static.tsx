...
export default function PopoverStatic() {
  return (
    <Popover.Root>
      <Popover.Trigger
        className={(state) =>
          `d-f ai-c jc-c w-10 h-10 bw-1 bc-silver-2 br-md bg-white c-slate-10 us-none c-p fv:ow-2 fv:oo-2 fv:oc-indigo-5 ${
      ...
      <Popover.Portal>
        <Popover.Positioner sideOffset={8}>
          <Popover.Popup className="px-4 py-3 w-56 bg-white bc-silver-2 c-slate-10 bw-1 br-xl bs-o-xs">
