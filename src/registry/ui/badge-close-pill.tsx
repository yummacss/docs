...
export default function BadgeClosePill() {
  return (
    <div className="d-f fd-c g-6 ai-c">
      <div className="d-f ai-c g-1 pl-4 pr-2 py-1 bg-white bc-silver-2 br-9999 bw-1 bs-o-xs">
      ...
      <div className="d-f ai-c g-1 pl-4 pr-2 py-1 bg-indigo-1 br-9999 bw-0">
      ...
      <div className="d-f ai-c g-1 pl-4 pr-2 py-1 bg-indigo c-white br-9999 bw-0">
