  ...
  return (
    <div className="d-f fd-c g-6 ai-c">
      ...
      <div className="d-f ai-c g-1 px-2 py-1 bg-indigo-1 bc-indigo-2 br-pill bw-1">
        <span className="c-indigo-7 fs-xs fw-500 us-none">Notifications</span>
      ...
      <div className="d-f ai-c g-1 px-2 py-1 bg-indigo c-white br-pill bw-0">
        <span className="fs-xs fw-500 us-none">Notifications</span>
        <span className="d-f ai-c jc-c w-4 h-4 bg-white c-indigo br-pill fs-xs fw-500">3</span>
      </div>
    </div>
  );
}