...
export default function FieldSuccess() {
  return (
    <Field.Root className="d-f fd-c g-2 c-slate-10 fs-sm">
      ...
      <div className="d-f ai-c w-64 bg-white bc-mint-5 bw-1 br-lg bs-o-xs">
        <input
          type="text"
          placeholder="@handle"
          aria-label="Change username"
          defaultValue="@sarah"
          className="f-1 h-10 pl-4 pr-2 bg-transparent c-slate-10 fs-md us-none fv:oo--1 fv:oc-mint-5"
        />
