            ...
            <Select.Portal>
              ...
              >
                <Select.Popup
                  ...
                  className="py-1 w-68 bg-white bc-silver-2 bw-1 br-md bs-o-xs"
                >
                  <Select.List className="p-r o-auto">
                    {members.map(({ name, role, avatar }) => (
                      <Select.Item
                        ...
                        value={name}
                        className={(state) =>
                          `d-f ai-c g-3 py-2 px-3 fs-sm us-none c-p br-md mx-1 c-slate-10 fw-500 ${state.highlighted ? "bg-silver-1/50" : "bg-transparent"}`
                        }
                      >
