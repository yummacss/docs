...
export default function ExampleButton() {
  return (
    <div className="d-f ai-c g-3">
      <Button className="b-0 px-2 py-1 bg-indigo h:bg-indigo-8 bc-indigo-7 c-white br-2 bw-1 fw-600 fs-xs bs-o-xs tp-c tdu-150 ttf-io us-none c-p fv:os-s fv:ow-2 fv:oo-2 fv:oc-indigo-6">
        Button sm
      </Button>
