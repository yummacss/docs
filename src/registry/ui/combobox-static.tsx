  ...
  return (
    <Combobox.Root items={users} open={open} onOpenChange={setOpen}>
      <div className="d-f p-r fd-c g-2 c-slate-10 fs-sm">
        <label htmlFor="user-input-static" className="fw-500">
          Mention user
        </label>
        <div className="p-r">
          <Combobox.Input
            ...
            className="h-10 w-64 pl-4 pr-16 bg-white bc-silver-3 c-slate-10 bw-1 br-lg fs-md bs-o-xs fv:oo--1 fv:oc-indigo-6"
          />
