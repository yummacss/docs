export default function AccordionBasic() {
  return (
    <div className="d-f fd-c">
      <details className="b-1 bc-silver-2 bb-none">
      ...
      <details open className="b-1 bt-0 bc-silver-2 rad-b-0">
        <summary className="p-4 c-p d-f jc-sb ai-c lst-none fw-600 rad-0">
        ...
        <div className="px-4 pb-4 tc-slate fs-sm lh-4">
          <p className="tc-slate-6">Yes, Yumma UI is be fully responsive and works great on all devices.</p>
        </div>
      </details>
    </div>
  );
