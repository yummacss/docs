  ...
  return (
    <div className="d-f fd-c">
      {items.map((item, index) => (
        <div key={item.id} className="d-f fd-c w-full">
          <h4 className="m-0">
            <button
              type="button"
              ...
              className={`p-4 c-p d-f jc-sb ai-c w-full b-1 bc-silver-2 fw-600 rad-0 bg-white h:bg-silver-1 f:oc-silver-1 f:os-s f:ow-2 ${index !== items.length - 1 ? "bb-none" : ""
                }`}
            >
