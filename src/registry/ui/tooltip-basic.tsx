...
export default function ExampleTooltip() {
  return (
    <Tooltip.Provider>
      <div className="d-f br-1 bw-1 bc-silver-4 bg-silver-1 p-px">
        <Tooltip.Root>
          <Tooltip.Trigger className="d-f d-8 ai-c jc-c b-0 br-1 bg-transparent c-slate-12 us-none h:bg-silver-2 fv:os-s fv:ow-2 fv:oo--1 fv:oc-blue-8 data-popup-open:bg-silver-2">
            <BoldIcon className="d-4" />
          </Tooltip.Trigger>
          <Tooltip.Portal>
            <Tooltip.Positioner sideOffset={10}>
              <Tooltip.Popup className="d-f fd-c px-2 py-1 br-1 bg-white fs-sm c-slate-12 bsh-lg bw-1 bc-silver-4 o-1 transition-all d-150 e-cb data-ending-style:o-0 data-ending-style:s-90 data-starting-style:o-0 data-starting-style:s-90 data-instant:transition-none">
                <Tooltip.Arrow className="d-f data-side:bottom:t--2 data-side:bottom:r-0 data-side:left:r--3.5 data-side:left:r-90 data-side:right:l--3.5 data-side:right:r--90 data-side:top:b--2 data-side:top:r-180">
                  <ArrowSvg />
                </Tooltip.Arrow>
                Bold
              </Tooltip.Popup>
