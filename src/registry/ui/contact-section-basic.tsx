export default function ContactSectionBasic() {
  return (
    <section className="py-12 px-6">
      <h2 className="ff-s fs-3xl fw-600 c-slate-10 mb-6">Contact us</h2>
      <div className="d-g gtc-1 sm:gtc-3 g-6">
        <div className="p-6 bw-1 bc-silver-4 br-0">
          ...
          <h3 className="ff-s fs-md fw-600 c-slate-10 mb-1">Live Chat</h3>
        ...
        <div className="p-6 bw-1 bc-silver-4 br-0">
          ...
          <h3 className="ff-s fs-md fw-600 c-slate-10 mb-1">Email</h3>
        ...
        <div className="p-6 bw-1 bc-silver-4 br-0">
          ...
          <h3 className="ff-s fs-md fw-600 c-slate-10 mb-1">Office</h3>
