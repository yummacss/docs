...
import { Bug, Rocket, TriangleExclamation } from "@gravity-ui/icons";
...
const tabs = [
  { value: "features", label: "Features", icon: Rocket },
  { value: "fixes", label: "Fixes", icon: Bug },
  { value: "known-issues", label: "Known Issues", icon: TriangleExclamation },
];
