export default function TestimonialSectionBasic() {
  return (
    <section className="py-12 px-6 ta-c max-w-3xl m-auto d-f fd-c ai-c">
      <blockquote>
        <p className="fs-xl fw-500 tc-slate-8 lh-4 mb-6">
      ...
      <div className="d-12 rad-9 o-h mb-2">
        <img
      ...
      <div className="fs-md fw-500 tc-black fs-n mb-1">Phoenix Baker</div>
      <div className="fs-sm tc-silver-10 mb-4">Engineering Manager</div>
      <div className="d-f ai-c g-1 tc-orange">
        <svg
