...
export default function ExampleMenubar() {
  return (
    <Menubar className="d-f br-1 bw-1 bc-silver-4 bg-silver-1 p-1">
      <Menu.Root>
        <Menu.Trigger className="h-8 br-1 px-3 fs-sm fw-500 c-slate-6 ow-0 us-none fv:bg-silver-2 menubar-trigger">
          File
        </Menu.Trigger>
        <Menu.Portal>
          <Menu.Positioner className="ow-0" sideOffset={6}>
            <Menu.Popup className="br-1 bg-white c-slate py-1 bs-md bw-1 bc-silver-4 menubar-popup">
              <Menu.Item className="d-f ai-c jc-sb g-4 px-4 py-2 fs-sm c-d us-none ow-0 menubar-item">
                New
              </Menu.Item>
              <Menu.Item className="d-f ai-c jc-sb g-4 px-4 py-2 fs-sm c-d us-none ow-0 menubar-item">
                Open
              ...
              <Menu.SubmenuRoot>
                <Menu.SubmenuTrigger className="d-f w-full ai-c jc-sb g-4 px-4 py-2 fs-sm c-d us-none ow-0 menubar-item">
                  Export
                  <CaretRightIcon size={10} />
                </Menu.SubmenuTrigger>
                <Menu.Portal>
                  <Menu.Positioner className="ow-0">
                    <Menu.Popup className="br-1 bg-white c-slate py-1 bs-md bw-1 bc-silver-4 menubar-submenu">
                      <Menu.Item className="d-f ai-c jc-sb g-4 px-4 py-2 fs-sm c-d us-none ow-0 menubar-item">
                        PDF
                      </Menu.Item>
                      <Menu.Item className="d-f ai-c jc-sb g-4 px-4 py-2 fs-sm c-d us-none ow-0 menubar-item">
