  ...
  return (
    <Autocomplete.Root items={settings} open={open} onOpenChange={setOpen}>
      <div className="d-f fd-c g-2">
        <label htmlFor="icon-trailing-input" className="c-slate-10 fs-sm fw-500">
          Search settings
        </label>
        <div className="d-f p-r ai-c">
          <Autocomplete.Input
            id="icon-trailing-input"
            placeholder="Account, Privacy, & more"
            className="h-10 w-64 pl-4 pr-10 bg-white bc-silver-3 c-slate-10 bw-1 br-lg fs-md bs-o-xs fv:ow-2 fv:oo--1 fv:oc-indigo-5"
          />
