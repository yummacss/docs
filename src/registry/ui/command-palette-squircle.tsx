...
export default function CommandPaletteSquircle() {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger
        render={
          <Button className="bg-white d-f ai-c g-2 px-3 py-2 bc-silver-2 c-slate-10 br-xxl cs-s bw-1 fw-500 tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5" />
        }
      >
                          ...
                          {group.items.map((item) => (
                            <Combobox.Item
                              ...
                              className={(state: { highlighted: boolean }) =>
                                `d-f ai-c g-2 py-2 px-2 mx-2 fs-sm us-none c-p br-xxl cs-s ${
                                  state.highlighted
                                    ? "bg-silver-1/50"
                                    : "bg-transparent"
                                }`
