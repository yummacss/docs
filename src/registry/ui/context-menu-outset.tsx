...
export default function ContextMenuOutset() {
  const [open, setOpen] = useState(false);

  return (
    <ContextMenu.Root open={open} onOpenChange={setOpen}>
      <ContextMenu.Trigger className="d-f bg-white ai-c jc-c h-48 w-60 bc-silver-3 c-slate-10 bw-1 bs-d br-xxl cs-s fs-sm fw-500 us-none bs-o-xs">
        Right-click task
      </ContextMenu.Trigger>
