...
export default function CollapsibleSquircle() {
  ...
  return (
    ...
    >
      <Collapsible.Trigger className="d-f ai-c jc-sb g-3 w-100% py-3 px-3 bg-white bc-silver-3 bbw-1 ta-l c-p fv:oo-1 fv:oc-indigo-5 br-xxl cs-s">
