  ...
  return (
    <div className="d-f fd-c g-6 ai-c">
      ...
      <div className="d-f ai-c g-1 px-2 py-1 bg-indigo c-white br-9999 bw-0">
        <Bookmark fill="currentColor" className="w-3 h-3" />
