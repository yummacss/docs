...
export default function CommandPaletteSquare() {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger
        render={
          <Button className="bg-white d-f ai-c g-2 px-3 py-2 bc-silver-2 c-slate-10 bw-1 fw-500 tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5" />
        }
      >
          ...
          <Dialog.Portal keepMounted>
            ...
            <div className="d-f p-f i-0 ai-c jc-c">
              <Dialog.Popup
                ...
                className="o-h w-96 bg-white bc-silver-2 c-slate-12 bw-1"
                style={{ maxWidth: "90vw" }}
              >
