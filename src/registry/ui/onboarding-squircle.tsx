...
export default function OnboardingSquircle() {
  ...
  return (
    ...
    >
      <AlertDialog.Trigger
        render={
          <Button className="bg-white px-3 py-2 bc-silver-2 c-slate-10 bw-1 br-xxl cs-s fw-500 tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5" />
        }
      >
        Start your journey
      </AlertDialog.Trigger>
          ...
          <AlertDialog.Portal keepMounted>
            ...
            <div className="d-f p-f i-0 ai-c jc-c">
              <AlertDialog.Popup
                ...
                className="o-h p-r w-96 bg-white bc-silver-2 c-slate-12 br-3xl cs-s bw-1"
                style={{ maxWidth: "90vw" }}
              >
                <div className="d-f ai-c jc-sb px-8 pt-5">
                  ...
                  <div className="d-f g-2">
                    {!isFirst && (
                      <Button
                        onClick={goPrev}
                        className="d-f ai-c jc-c w-8 h-8 bg-white bc-silver-2 c-slate-10 bw-1 br-xxl cs-s tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5"
                      >
                    ...
                    {isLast ? (
                      <AlertDialog.Close
                        render={
                          <Button className="d-f ai-c jc-c w-8 h-8 bg-indigo h:bg-indigo-8 bc-indigo-7 c-white bw-1 br-xxl cs-s tp-c tdu-150 ttf-io us-none fv:oo-2 fv:oc-indigo-5" />
                        }
                      >
                      ...
                      <Button
                        onClick={goNext}
                        className="d-f ai-c jc-c w-8 h-8 bg-indigo h:bg-indigo-8 bc-indigo-7 c-white bw-1 br-xxl cs-s tp-c tdu-150 ttf-io us-none fv:oo-2 fv:oc-indigo-5"
                      >
                    ...
                    <AnimatePresence mode="wait" custom={page}>
                      ...
                      >
                        <div className="d-ib p-r">
                          <div className="p-a l--3 h-12 w-12 bg-white/70 bc-silver-2 bw-1 br-xxl cs-s ro--3 tty-1" />
                          <div className="p-a r--3 h-12 w-12 bg-white/70 bc-silver-2 bw-1 br-xxl cs-s ro-3 tty-1" />
                          <div className="d-f p-r ai-c jc-c h-14 w-14 bg-white bc-silver-2 bw-1 br-xxl cs-s">
