...
export default function AutocompleteSquircle() {
    ...
    <Autocomplete.Root items={teamMembers} open={open} onOpenChange={setOpen}>
      <div className="d-f fd-c g-2">
        ...
        <Autocomplete.Input
          ...
          className="h-10 w-64 pl-4 bg-white bc-silver-3 c-slate-12 bw-1 br-xxl cs-s fs-md fv:oo--1 fv:oc-indigo-5"
        />
      </div>
        ...
        {open && (
          <Autocomplete.Portal keepMounted>
            <Autocomplete.Positioner className="ow-0" sideOffset={8}>
              ...
              >
                <Autocomplete.Popup className="o-h w-64 bg-white bc-silver-2 c-slate-10 bw-1 br-3xl cs-s">
                    ...
                    {(member: TeamMember) => (
                      <Autocomplete.Item
                        ...
                        render={(props, state) => (
                          <div
                            {...props}
                            className={`d-f ai-c g-3 py-2 px-3 mx-1 c-slate-10 br-xxl cs-s fs-sm us-none c-p ${
                              state.highlighted
                                ? "bg-silver-2/50"
                                : "bg-transparent"
                            }`}
