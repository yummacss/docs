...
export default function ExampleButton() {
  return (
    <div className="d-f ai-c g-3">
      <Button className="b-0 px-2 py-1 bg-white bc-silver-2 c-slate-10 br-2 bw-1 fw-600 fs-sm bs-o-xs tp-c tdu-150 ttf-io us-none c-p h:bg-silver-1/50 fv:os-s fv:ow-2 fv:oo-2 fv:oc-indigo-6">
        Button sm
      </Button>
