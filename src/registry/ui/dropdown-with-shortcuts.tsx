export default function DropdownWithShortcuts() {
    return (
        <div className="d-ib">
            ...
            <div className="mt-1 p-1 bg-white b-1 bc-silver-4 rad-0 bs-3 min-w-64">
                <button
                    type="button"
                    className="d-f ai-c jc-sb w-full ta-l px-3 py-2 rad-0 fs-sm tc-slate-8 bg-transparent b-0 h:bg-silver-1 c-p"
                >
                    <div className="d-f ai-c g-3">
                        ...
                        <div className="d-f fd-c">
                            <span className="fw-600">New file</span>
                ...
                >
                    <div className="d-f ai-c g-3">
                        ...
                        <div className="d-f fd-c">
                            <span className="fw-600">Copy link</span>
                ...
                >
                    <div className="d-f ai-c g-3">
                        ...
                        <div className="d-f fd-c">
                            <span className="fw-600">Edit file</span>
                    ...
                    <div className="d-f ai-c g-1 p-1 bg-silver-1 rad-0 tc-slate-5">
                        ...
                        <span className="fs-xs">E</span>
                    </div>
                </button>
                <hr className="my-1 b-0 bt-1 bc-silver-4" />
                <button
                    type="button"
                    className="d-f ai-c jc-sb w-full ta-l px-3 py-2 rad-0 fs-sm tc-red bg-transparent b-0 h:bg-red-1 c-p"
                >
                    <div className="d-f ai-c g-3">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="d-f fd-c">
                            <span className="fw-600">Delete file</span>
