...
const tabs = [
  ...
  },
  {
    ...
    panelDesc:
      "Assign Critical, High, Medium, or Low priority to tasks based on business impact and delivery deadlines.",
  },
  {
    value: "labels",
    label: "Labels",
    ...
    panelDesc:
      "Organise work across teams with custom labels for feature types, departments, milestones, and release versions.",
  },
];
