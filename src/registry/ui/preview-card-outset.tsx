...
export default function PreviewCardOutset() {
  return (
    <PreviewCard.Root>
            ...
            <div className="d-f ai-c g-3">
              <div className="p-r">
                <Avatar.Root className="d-if o-h ai-c jc-c w-10 h-10 bc-white br-9999 bw-1 va-m us-none">
                  <Avatar.Image
                    src="https://api.dicebear.com/9.x/notionists/svg?seed=Jordan&backgroundColor=B4E9F2"
                    alt="Jordan"
              ...
              <div className="d-f fd-c g-0">
                <span className="c-slate-10 fs-sm fw-500">Jordan</span>
                <span className="c-slate-6 fs-xs">Product Manager</span>
              </div>
            </div>
            <div className="d-f ai-c g-2">
              <span className="c-slate-6 fs-xs">6 tasks assigned</span>
            </div>
          </PreviewCard.Popup>
