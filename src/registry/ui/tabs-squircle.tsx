...
export default function ExampleTabsSquircle() {
  ...
  return (
    <Tabs.Root
      ...
      className="w-fc bg-silver-1 br-3xl cs-s bw-1 bc-silver-2"
    >
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Tabs.Tab
              key={tab.value}
              value={tab.value}
              className={`d-f p-r zi-10 fg-1 ai-c jc-c py-2 px-3 bg-transparent br-xxl cs-s us-none fv:oo--1 fv:oc-indigo ${
