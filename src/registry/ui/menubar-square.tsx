  ...
  return (
    <Menubar className="d-f g-1 p-1 bg-white bc-silver-2 bw-1">
      <Menu.Root open={fileOpen} onOpenChange={setFileOpen}>
        <Menu.Trigger
          className={(state) =>
            `h-8 px-3 fs-sm fw-500 c-slate-10 us-none c-p bw-0 bg-transparent ${
            ...
            <Menu.Portal keepMounted>
              <Menu.Positioner className="ow-0" sideOffset={8}>
                ...
                >
                  <Menu.Item
                    className={(state) =>
                      `d-f ai-c jc-sb g-4 px-3 py-2 fs-sm us-none c-p mx-1 fw-500 ${state.highlighted ? "bg-silver-1/50" : "bg-transparent"}`
                    }
                  >
                    New task
                  </Menu.Item>
