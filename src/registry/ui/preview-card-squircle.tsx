...
export default function PreviewCardSquircle() {
  return (
    <PreviewCard.Root>
      ...
      <PreviewCard.Portal>
        <PreviewCard.Positioner sideOffset={8}>
          <PreviewCard.Popup
            ...
            className="d-f fd-c g-3 w-64 p-3 bg-white bc-silver-2 br-xxl bw-1 cs-s bs-o-xs"
          >
            <div className="d-f ai-c g-3">
              ...
              <div className="d-f fd-c g-0">
                <span className="c-slate-10 fs-sm fw-500">Maya</span>
                <span className="c-slate-6 fs-xs">Design Lead</span>
              </div>
            </div>
            <div className="d-f ai-c g-2">
              <span className="c-slate-6 fs-xs">5 tasks assigned</span>
            </div>
          </PreviewCard.Popup>
