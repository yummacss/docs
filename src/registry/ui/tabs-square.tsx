...
export default function ExampleTabsSquare() {
  ...
  return (
    <Tabs.Root
      ...
      className="w-fc bg-silver-1 bw-1 bc-silver-2"
    >
      <Tabs.List className="d-f p-r g-1 p-1">
        {tabs.map((tab) => {
          ...
          return (
            <Tabs.Tab
              key={tab.value}
              value={tab.value}
              className={`d-f p-r zi-10 fg-1 ai-c jc-c py-2 px-3 bg-transparent us-none fv:oo--1 fv:oc-indigo ${
        ...
        <Tabs.Indicator
          className="p-a l-0 zi-0 bg-white bs-o-xs tp-a tdu-200 ttf-io"
          style={{
