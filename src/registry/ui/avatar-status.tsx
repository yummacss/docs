  ...
  return (
    <div className="d-f ai-c g-4">
      ...
      <div className="p-r">
        ...
        <span className="p-a b-0 r-0 d-4 br-pill bg-green-6 bw-2 bc-white" />
      </div>
      ...
      <div className="p-r">
        ...
        <span className="p-a b-0 r-0 d-4 br-pill bg-slate-4 bw-2 bc-white" />
      </div>
      ...
      <div className="p-r">
        ...
        <span className="p-a b-0 r-0 d-4 br-pill bg-red-6 bw-2 bc-white" />
      </div>
    </div>
  );
}
