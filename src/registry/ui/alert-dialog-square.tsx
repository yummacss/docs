...
export default function AlertDialogSquare() {
  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={setOpen}>
      <AlertDialog.Trigger
        render={
          <Button className="d-if ai-c px-3 py-2 bg-red h:bg-red-8 bc-red-7 c-white bw-1 fw-500 tp-c tdu-150 ttf-io us-none fv:oo-2 fv:oc-red-6" />
        }
      >
        Remove member
      </AlertDialog.Trigger>
            ...
            <div className="d-f p-f i-0 ai-c jc-c">
              ...
              >
                ...
                <div className="d-f fd-c ai-c g-3 pt-10 pb-6 px-4 bg-white">
                  <span className="d-f ai-c jc-c w-12 h-12 bg-red-1/50 c-red">
                ...
                <div className="d-f jc-c g-3 px-4 pb-4 bg-white">
                  <AlertDialog.Close
                    render={
                      <Button className="px-4 py-2 bc-silver-2 c-slate-10 bw-1 fw-500 tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5" />
                    }
                  >
                    Cancel
                  </AlertDialog.Close>
                  <AlertDialog.Close
                    render={
                      <Button className="px-4 py-2 bg-red h:bg-red-8 bc-red-7 c-white bw-1 fw-500 tp-c tdu-150 ttf-io us-none fv:oc-red-6 fv:oo-2" />
                    }
                  >
                    Remove
                  </AlertDialog.Close>
