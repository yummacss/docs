...
export default function EmptyStateBase() {
  return (
    <div className="d-f fd-c ai-c jc-c g-4 p-8">
      <div className="d-f ai-c jc-c w-10 h-10 bg-white bc-silver-3 c-indigo br-lg bw-1 bs-i-sm">
      ...
      <div className="d-f g-3">
        <Button className="d-if ai-c px-3 py-2 bg-white bc-silver-2 c-slate-10 br-lg bw-1 fw-500 bs-o-xs tp-c tdu-150 ttf-io us-none c-p h:bg-silver-1/50 fv:oo-2 fv:oc-indigo-5">
          Learn more
        </Button>
