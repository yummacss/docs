...
export default function AvatarXs() {
  return (
    <div className="d-f ai-c g-4">
      <div className="p-r">
        <Avatar.Root className="d-if o-h ai-c jc-c w-8 h-8 bg-silver-1 bc-white br-pill bw-1 va-m us-none">
          <Avatar.Image
      ...
      <Avatar.Root className="d-if o-h ai-c jc-c w-8 h-8 bg-indigo-1 bc-indigo-3 br-pill bw-1 va-m us-none">
        <Avatar.Fallback className="d-f ai-c jc-c w-full h-full c-indigo fs-xs fw-500">
          S
        </Avatar.Fallback>
      </Avatar.Root>
    </div>
