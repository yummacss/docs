    ...
    <Field.Root className="d-f fd-c g-2">
      ...
      <Select.Root defaultValue={null}>
        <Select.Trigger
          ...
          className={(state) =>
            `d-f ai-c jc-sb h-10 w-64 bw-1 bc-silver-3 br-md bg-white px-3 c-slate-10 us-none c-p bs-o-xs fv:oo--1 fv:oc-indigo-5 ${
        ...
        <Select.Portal>
          ...
          >
            <Select.Popup className="py-1 w-64 bg-white bc-silver-2 bw-1 br-md bs-o-xs">
