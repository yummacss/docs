...
export default function FileUploadSquircle() {
  return (
    <section className="d-f fd-c ai-c g-3 w-100 bg-white bc-silver-2 br-3xl cs-s bw-2 bs-d">
      <div className="d-f fd-c ai-c g-2 p-8 bg-white ta-c">
        <div className="d-f ai-c jc-c w-10 h-10 bg-white bc-silver-2 br-xxl cs-s bw-1 bs-o-xs">
