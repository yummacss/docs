...
export default function BadgeClose() {
  return (
    <div className="d-f fd-c g-6 ai-c">
      ...
      <div className="d-f ai-c g-1 pl-3 pr-2 py-1 bg-indigo-1 br-sm bw-0">
        <span className="c-indigo-7 fs-xs fw-500 us-none">Blocked</span>
        <Button className="d-f ai-c jc-c w-4 h-4 p-0 bg-transparent c-slate-6 br-sm h:bg-indigo-2 fv:oo-2 fv:oc-indigo-5">
          <Xmark className="w-3 h-3 c-indigo-7" />
        </Button>
      </div>
      <div className="d-f ai-c g-1 pl-3 pr-2 py-1 bg-indigo c-white br-sm bw-0">
        <span className="fs-xs fw-500 us-none">Blocked</span>
        <Button className="d-f ai-c jc-c w-4 h-4 p-0 bg-transparent c-slate-6 br-sm h:bg-indigo-8 fv:oo-2 fv:oc-indigo-5">
