  ...
  return (
    <div className="d-f fd-c g-6 ai-c">
      <div className="d-f ai-c g-1 px-2 py-1 bg-white bc-silver-2 br-sm bw-1 bs-o-xs">
        ...
        <Button className="d-f ai-c jc-c w-4 h-4 p-0 bg-transparent c-slate-6 br-sm h:bg-silver-2 fv:ow-2 fv:oo-2 fv:oc-indigo-5">
      ...
      <div className="d-f ai-c g-1 px-2 py-1 bg-indigo-1 br-sm bw-0">
        ...
        <Button className="d-f ai-c jc-c w-4 h-4 p-0 bg-transparent c-slate-6 br-sm h:bg-indigo-2 fv:ow-2 fv:oo-2 fv:oc-indigo-5">
      ...
      <div className="d-f ai-c g-1 px-2 py-1 bg-indigo c-white br-sm bw-0">
        ...
        <Button className="d-f ai-c jc-c w-4 h-4 p-0 bg-transparent c-slate-6 br-sm h:bg-indigo-8 fv:ow-2 fv:oo-2 fv:oc-indigo-5">
