...
export default function ButtonPill() {
  return (
    <div className="d-f fd-c g-6 ai-c">
      <Button className="d-if ai-c g-2 px-3 py-2 bg-indigo h:bg-indigo-8 h:bg-indigo-1/50 bc-indigo-7 c-white br-md bw-1 fw-500 bs-o-xs tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-indigo-6">
