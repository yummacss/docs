...
export default function PreviewCardSquare() {
  return (
    <PreviewCard.Root>
      ...
      <PreviewCard.Portal>
        <PreviewCard.Positioner sideOffset={8}>
          <PreviewCard.Popup
            ...
            className="d-f fd-c g-3 w-64 p-3 bg-white bc-silver-2 bw-1 bs-o-xs"
          >
            <div className="d-f ai-c g-3">
              <div className="p-r">
                <Avatar.Root className="d-if o-h ai-c jc-c w-10 h-10 bc-white br-9999 bw-1 va-m us-none">
                  <Avatar.Image
                    src="https://api.dicebear.com/9.x/open-peeps/svg?seed=Alex&backgroundColor=DAF0B9"
                    alt="Alex"
            ...
            <div className="d-f ai-c g-2">
              <span className="c-slate-6 fs-xs">2 tasks assigned</span>
            </div>
          </PreviewCard.Popup>
