      ...
      <div className="d-f p-r fd-c g-2 c-slate-10 fs-sm">
        ...
        <div className="p-r">
          <Combobox.Input
            ...
            className="h-8 w-56 pl-4 pr-16 bg-white bc-silver-3 c-slate-10 bw-1 br-md fs-md bs-o-xs fv:oo--1 fv:oc-indigo-5"
          />
        ...
        {open && (
          <Combobox.Portal keepMounted>
            <Combobox.Positioner className="ow-0" sideOffset={8}>
              ...
              >
                <Combobox.Popup className="o-h w-56 bg-white bc-silver-2 c-slate-10 bw-1 br-md bs-o-xs">
