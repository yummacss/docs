  ...
  return (
    <Field.Root className="d-f fd-c g-2">
      ...
      <Select.Root defaultValue={null} open={open} onOpenChange={setOpen}>
        <Select.Trigger
          id="select-sm"
          className={`d-f ai-c jc-sb h-8 w-56 bw-1 bc-silver-3 br-lg bg-white px-3 c-slate-10 us-none c-p fv:oo--1 fv:oc-indigo-5 ${
            ...
            <Select.Portal>
              ...
              >
                <Select.Popup
                  ...
                  className="py-1 w-56 bg-white bc-silver-2 bw-1 br-lg"
                >
