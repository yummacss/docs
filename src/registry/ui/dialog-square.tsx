...
export default function DialogSquare() {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger
        render={
          <Button className="px-3 py-2 bc-silver-2 c-slate-10 bw-1 fw-500 tp-c tdu-150 ttf-io us-none h:bg-silver-1/50 fv:ow-2 fv:oo-2 fv:oc-indigo-5" />
        }
      >
        Request access
      </Dialog.Trigger>
            ...
            <div className="d-f p-f i-0 ai-c jc-c">
              ...
              >
                <div className="d-f jc-sb ai-c px-4 py-2 bg-silver-1">
                  ...
                  <Dialog.Close
                    render={
                      <Button className="d-f ai-c jc-c w-7 h-7 c-slate-6 bw-0 h:bg-silver-2 fv:ow-2 fv:oo-2 fv:oc-indigo-5" />
                    }
                  >
                ...
                <div className="d-g gtc-2 g-3 px-4 py-4 bg-white">
                  ...
                  <Dialog.Close
                    render={
                      <Button className="px-3 py-2 bg-indigo h:bg-indigo-8 bc-indigo-7 c-white bw-1 fw-500 tp-c tdu-150 ttf-io us-none fv:oc-indigo-5 fv:ow-2 fv:oo-2" />
                    }
                  >
                    Confirm
                  </Dialog.Close>
