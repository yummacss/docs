...
export default function CollapsibleIconsLeft() {
  ...
  return (
    ...
    >
      <Collapsible.Trigger className="d-f ai-c g-3 w-100% py-3 px-3 bg-white bc-silver-3 bbw-1 ta-l c-p fv:oo-1 fv:oc-indigo-5">
        <motion.span
          initial={false}
