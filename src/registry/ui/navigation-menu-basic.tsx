  ...
  return (
    <NavigationMenu.Root className="min-w-max br-1 bw-1 bc-silver-4 bg-silver-1 p-1 c-slate">
      <NavigationMenu.List className="p-r d-f m-0 p-0">
        <NavigationMenu.Item>
          <NavigationMenu.Trigger className="d-f ai-c jc-c g-1 h-10 px-3 m-0 ow-0 bw-0 br-1 bg-transparent fs-md fw-500 c-slate us-none td-n c-p navmenu-trigger">
            Overview
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link
            ...
            className="d-f ai-c jc-c g-1 h-10 px-3 m-0 ow-0 bw-0 br-1 bg-transparent fs-md fw-500 c-slate us-none td-n c-p navmenu-trigger"
          >
            GitHub
          </NavigationMenu.Link>
        </NavigationMenu.Item>
