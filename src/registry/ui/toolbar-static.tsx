...
import { ArrowDownUp, LayoutList, Plus, Cog, Table, Kanban } from "lucide-react";
import { useState } from "react";

export default function ToolbarStatic() {
    ...
    <Toolbar.Root className="d-f ai-c g-1 p-1 bg-white bc-silver-2 br-lg bw-1">
      ...
      >
        <Toggle
          ...
          aria-label="Grid"
          className={(state) =>
            `d-f w-9 h-9 ai-c jc-c bw-0 br-md us-none c-p ${
              state.pressed
                ? "bg-indigo c-white"
