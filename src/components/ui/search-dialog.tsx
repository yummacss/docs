...
export function SearchDialog({ open, onClose }: SearchDialogProps) {
  ...
  const getCategoryIcon = (category: string) => {
    if (category === "docs") {
      return <OpenBook className="w-4 h-4 c-accent-dim" />;
    }
    if (category === "handbook") {
      return <OpenBook className="w-4 h-4 c-accent-dim" />;
    }
    return <ComponentSolid className="w-4 h-4 c-accent-dim" />;
  };
              ...
              >
                ...
                >
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="f-1 min-w-0">
                                ...
                                {item.description && (
                                  <div className="o-h c-accent-dim fs-xs tw-n to-e ws-nw">
                              ...
                              {isSelected && (
                                <LongArrowDownLeftSolid className="fs-0 w-4 h-4 c-accent-dim" />
                              )}
                            </Button>
                          );
                        })}
                  ...
                  {flatResults.length === 0 && (
                    <div className="px-4 py-8 c-accent-dim ta-c fs-md">
                      No results found for "{query}"
                    </div>
                  )}
                </div>

                <div className="d-f ai-c jc-sb px-4 py-2 bc-border c-accent-dim btw-1 fs-xs">
