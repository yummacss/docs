          ...
          <nav className="d-f ai-c jc-sb">
            ...
            <div className="d-f ai-c g-2 @sm:g-4">
              ...
              <Button
                ...
                className="d-f ai-c jc-c g-2 h-8 px-3 bc-border bg-surface a:bg-surface-7 c-accent-dim h:c-ink bw-1 fs-sm bf-b-sm @lg:px-4 fv:oc-ink fv:ow-2"
              >
              ...
              {showMobileDrawer && (
                <Button
                  ...
                  className="d-f p-r ai-c jc-c h-8 px-3 bc-border bg-surface h:bg-surface-8 c-accent-dim h:c-ink bw-1 bf-b-sm @lg:d-none fv:oc-ink fv:ow-2"
