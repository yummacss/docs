...
Every interactive element MUST have focus-visible styles. Use these exact utilities:

```
fv:ow-2 fv:oo-2 fv:oc-indigo-6
```

For danger/destructive buttons only:
```
fv:ow-2 fv:oo-2 fv:oc-red-6
```

For inputs with negative offset (so ring appears inside the border):
```
fv:ow-2 fv:oo--1 fv:oc-indigo-6
```

For accordion triggers (tighter offset):
```
fv:ow-2 fv:oo-1 fv:oc-indigo-6
```
...
```ts
const AVATARS = [
  { name: "Sarah",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Sarah" },
  { name: "Avery",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Avery" },
  { name: "Jude",      avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Jude" },
  { name: "Leo",       avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Leo" },
  { name: "Riley",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Riley" },
  { name: "Adrian",    avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Adrian" },
  { name: "Jessica",   avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Jessica" },
  { name: "Aiden",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Aiden" },
  { name: "Liam",      avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Liam" },
  { name: "Maria",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Maria" },
  { name: "Vivian",    avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Vivian" },
  { name: "Wyatt",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Wyatt" },
  { name: "Jade",      avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Jade" },
  { name: "Nolan",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Nolan" },
  { name: "Sophia",    avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Sophia" },
  { name: "Liliana",   avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Liliana" },
  { name: "Katherine", avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Katherine" },
  { name: "Aidan",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Aidan" },
  { name: "Jocelyn",   avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Jocelyn" },
  { name: "Sadie",     avatar: "https://api.dicebear.com/9.x/notionists-neutral/svg?seed=Sadie" },
];
```
...
```tsx
<Button className="d-if ai-c px-3 py-2 bg-indigo h:bg-indigo-8 bc-indigo-7 c-white br-md bw-1 fw-500 bs-o-md tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-indigo-6">
```

### Standard button (secondary)
```tsx
<Button className="d-if ai-c px-3 py-2 bg-white bc-silver-2 c-slate-10 br-md bw-1 fw-500 bs-o-xs tp-c tdu-150 ttf-io us-none c-p h:bg-silver-1/50 fv:ow-2 fv:oo-2 fv:oc-indigo-6">
```

### Standard button (danger)
```tsx
<Button className="d-if ai-c px-3 py-2 bg-red h:bg-red-8 bc-red-7 c-white br-md bw-1 fw-500 bs-o-md tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-red-6">
```

### Standard input
```tsx
<Input className="h-10 w-64 pl-4 bg-white bc-silver-3 c-slate-10 bw-1 br-lg fs-md bs-o-xs fv:ow-2 fv:oo--1 fv:oc-indigo-6" />
```

### Standard trigger (button that opens a panel)
```tsx
<Trigger className="d-f b-0 ai-c g-2 px-3 py-2 h-fc bg-white bc-silver-2 c-slate-10 br-lg bw-1 fw-500 bs-o-xs tp-c tdu-150 ttf-io us-none c-p h:bg-silver-1/50 fv:ow-2 fv:oo-2 fv:oc-indigo-6">
```
...
```tsx
<Button className="d-f ai-c jc-c h-7 px-3 bg-indigo h:bg-indigo-8 c-white br-pill fs-xs fw-500 tp-c tdu-150 ttf-io us-none fv:ow-2 fv:oo-2 fv:oc-indigo-6">
  Follow
</Button>
```
...
Popup: o-h w-96 bg-white bc-silver-2 c-slate-12 br-md bw-1 bs-o-lg
  Header: d-f jc-sb ai-c px-4 py-2 bg-silver-1/50
    Title: fs-md fw-500
    Close button: d-f b-0 ai-c jc-c w-7 h-7 bg-transparent c-slate-6 br-md h:bg-silver-2 fv:ow-2 fv:oo-2 fv:oc-indigo-6
...
```tsx
className={`d-f w-9 h-9 ai-c jc-c bw-0 br-md us-none c-p fv:ow-2 fv:oo-2 fv:oc-indigo-6 ${
