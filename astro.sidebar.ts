export const sidebar = [
				...
				items: [
					{
						...
						link: "docs/foundations/styling-elements",
					},
					{ label: "Configuration", link: "docs/foundations/config" },
					{
						label: "Pseudo-classes",
						link: "docs/foundations/pseudo-classes",
					},
					{
						label: "Media Queries",
						link: "docs/foundations/media-queries",
					},
					{ label: "Colors", link: "docs/foundations/colors" },
					{
						label: "Base Styles",
						link: "docs/foundations/base-styles",
					},
				],
			},
				...
				items: [
					{
						label: "Borders",
						autogenerate: {
							directory: "core/borders-outlines/borders",
						},
					},
					{
						label: "Outlines",
						autogenerate: {
							directory: "core/borders-outlines/outlines",
						},
					},
				],
			},
				...
				items: [
					{
						label: "Flexbox",
						autogenerate: {
							directory: "core/flexbox-grid/flexbox",
						},
					},
					{
						label: "Grid",
	...
	},
	{
		...
		items: [
			{
				label: "Get Started",
				autogenerate: { directory: "core-ui/get-started" },
			},
			{
				label: "Components",
				autogenerate: { directory: "core-ui/components" },
			},
		],
	},
	{
